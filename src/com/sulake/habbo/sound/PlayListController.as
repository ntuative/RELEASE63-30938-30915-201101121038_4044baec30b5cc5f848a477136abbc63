package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1888:String = "type_sound_machine";
      
      private const const_1610:String = "type_jukebox";
      
      private var var_549:HabboSoundManagerFlash10;
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_679,this.onSongFinishedPlayingEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_693,this.onSoundMachinePlayEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_827,this.onSoundMachineStopEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_582,this.onJukeboxInitEvent);
         this.var_85.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_552,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_679,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_85)
            {
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_693,this.onSoundMachinePlayEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_827,this.onSoundMachineStopEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_582,this.onJukeboxInitEvent);
               this.var_85.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_552,this.onDisposeEvent);
               this.var_85 = null;
            }
            if(this.var_383)
            {
      ...
      {
         this.startPlaying(this.const_1888);
      }
      ...
      {
         this.startPlaying(this.const_1610);
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_383[this.var_284] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_383.getValue(this.var_284) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_284 = param1;
         var _loc2_:IHabboSound = this.var_383.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         _loc2_.volume = this.var_549.volume;
         _loc2_.play();
         if(_loc3_.length >= 4)
         {
            this.var_549.notifyPlayedSong(_loc3_.name,_loc3_.creator);
         }
         var _loc5_:PlayListEntry = this.getNextEntry();
         if(_loc5_ != null && _loc5_.id != this.var_284)
         {
            _loc6_ = this.var_383[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1670 == this.const_1610)
         {
            this.var_74.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_)
         {
            _loc7_ = this.var_383[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_549.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_383.add(_loc3_.id,_loc7_);
            }
