package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager
   {
      ...
      private var var_878:TraxSequencer;
      
      private var var_572:PlayListController;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_976,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_879.add(param1,_loc2_);
         }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_166.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_166.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
         ...
         _loc4_.load(_loc3_);
         this.var_573.add(_loc4_,param1);
      }
      ...
      public function loadTraxSong(param1:int, param2:String) : IHabboSound
      {
         ...
         var _loc5_:* = [];
         var _loc6_:Array = this.var_711.getKeys();
         var _loc7_:int = 0;
         ...
         var _loc8_:TraxSequencer = new TraxSequencer(param1,_loc3_,this.var_711,events);
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_880.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_880 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_166 == null || this._connection == null || this._roomEngine == null || this.var_572 != null)
         {
            return;
         }
         this.var_572 = new PlayListController(this,events,this._roomEngine.events,this._connection);
      }
      
      private function onSampleLoadComplete(param1:Event) : void
      {
         var _loc2_:Sound = param1.target as Sound;
         var _loc3_:int = this.var_573.getValue(_loc2_);
         ...
         this.var_573.remove(_loc2_);
         this.var_711.add(_loc3_,_loc6_);
         if(this.var_573.length == 0 && this.var_710 != -1)
         {
            this.var_878.ready = true;
            events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_976,this.var_710));
            this.var_710 = -1;
            this.var_878 = null;
         }
      }
      ...
      private function onTraxLoadComplete(param1:Event) : void
      {
         ...
         this.var_572.checkSongPlayState(_loc2_.id);
      }
      
      private function ioErrorHandler(param1:Event) : void
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1463,this.var_710));
         this.var_710 = -1;
         this.var_878 = null;
      }
      ...
      {
         this.var_464 = param1;
         this.var_572.updateVolume(this.var_464);
