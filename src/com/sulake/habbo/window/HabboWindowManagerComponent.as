package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_399:uint = 3;
      
      private static const const_1238:uint = 1;
      ...
      private var var_917:IWindowRenderer;
      
      private var var_820:ISkinContainer;
      
      private var var_340:Array;
      
      private var var_1393:IEventDispatcher;
      
      private var var_1138:Boolean = false;
      
      private var var_1781:ProfilerOutput;
      
      private var var_1392:ProfilerAgentTask;
      
      private var var_1394:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_820 = new SkinContainer(_loc4_.content as XML,assets);
         this.var_917 = new WindowRenderer(this.var_820);
         this.var_186 = new Array(const_399);
         ...
         var _loc6_:int = 0;
         while(_loc6_ < const_399)
         {
            this.var_186[_loc6_] = new WindowContext("layer_" + _loc6_,this.var_917,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this._windowContext = this.var_186[const_1238];
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_358,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         this._windowContext.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1448,_loc7_);
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1781)
            {
               this.var_1781 = new ProfilerOutput(context,this,this.var_917);
            }
            this.var_1781.profiler = _loc3_;
            this.var_1392 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1392);
            this.var_1394 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1394);
            this.var_1138 = true;
         }
      }
      ...
      {
         return this.var_820.getDefaultAttributesByTypeAndStyle(param1,param2);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_356.length > 0)
         {
            this.var_1393.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_399 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1393.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_399)
         {
         ...
         if(WindowContext.var_356.length > 0)
         {
            WindowContext.var_356.flush();
         }
         this.var_1393.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1568,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1434,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1432,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1516,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_442,
            "style":WindowStyle.const_177,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
