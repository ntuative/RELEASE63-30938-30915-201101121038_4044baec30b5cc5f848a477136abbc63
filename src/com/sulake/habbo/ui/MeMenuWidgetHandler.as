   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver, IAvatarImageListener
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_450,this.onHelpTutorialEvent);
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_114,this.onHelpTutorialEvent);
            }
            this._container = null;
         }
         ...
         {
            (this._inventory as Component).events.addEventListener(HabboInventoryEffectsEvent.const_999,this.onAvatarEffectsChanged);
            (this._inventory as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_1068,this.onHabboClubSubscriptionChanged);
         }
         ...
         if(this._container.habboHelp)
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_450,this.onHelpTutorialEvent);
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_114,this.onHelpTutorialEvent);
         }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1354)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  _loc1_ = _loc5_.getCroppedImage(AvatarSetType.const_44);
                  _loc5_.dispose();
               }
               this.var_1354 = _loc3_;
               this.var_1704 = _loc1_;
            }
            else
            {
               _loc1_ = this.var_1704;
            }
         }
         ...
         if(_loc2_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_1088,HabboToolbarIconEnum.MEMENU);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_826);
         _loc1_.push(RoomWidgetDanceMessage.const_734);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_788);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_707);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_809);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_753);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_608);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_642);
         _loc1_.push(RoomWidgetStopEffectMessage.const_662);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1364);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1056);
         _loc1_.push(RoomWidgetToolbarMessage.const_645);
         _loc1_.push(RoomWidgetToolbarMessage.const_777);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_326);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1316);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1011);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_606);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_800);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_855);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1334);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_840);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_767);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_660);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_800:
               ...
               break;
            case RoomWidgetWaveMessage.const_826:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_734:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_788:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_707:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_809:
               if(this._inventory != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_642:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_924)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_186,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_608:
            ...
            case RoomWidgetStopEffectMessage.const_662:
            ...
            case RoomWidgetNavigateToRoomMessage.const_1056:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_606:
               if(this._container != null)
               {
                  this._container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_645:
               ...
               break;
            case RoomWidgetToolbarMessage.const_777:
               ...
               {
                  this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_453,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_326:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_855:
            ...
            case RoomWidgetStoreSettingsMessage.const_767:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_366,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_660:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_470));
               }
               break;
            case RoomWidgetClothingChangeMessage.const_340:
               this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_654));
               break;
            default:
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_617));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_114:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_114));
               break;
