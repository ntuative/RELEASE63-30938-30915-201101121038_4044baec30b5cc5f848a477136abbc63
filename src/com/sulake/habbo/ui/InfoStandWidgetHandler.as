   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_156,this.onUserTags);
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_156,this.onUserTags);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_745.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_745.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_583);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_639);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1464);
         _loc1_.push(RoomWidgetPetCommandMessage.const_487);
         _loc1_.push(RoomWidgetPetCommandMessage.const_602);
         _loc1_.push(RoomWidgetUserActionMessage.const_407);
         _loc1_.push(RoomWidgetUserActionMessage.const_365);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_819);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_408)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_365 || param1.type == RoomWidgetUserActionMessage.const_407 || param1.type == RoomWidgetUserActionMessage.const_463)
            {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_708:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1070,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_589:
               ...
               break;
            case RoomWidgetUserActionMessage.const_365:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_583:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_639:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_599);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_322);
                  ...
                  {
                     _loc23_ = this._container.sessionDataManager.method_4(_loc22_);
                  }
                  if(_loc23_ != null)
                  {
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1078);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1075);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_230)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_362)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_963)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc16_ != null)
               {
                  _loc13_.carryItem = _loc16_.getModel().getNumber(RoomObjectVariableEnum.const_510);
               }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_226)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_724);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1452;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1066;
                  }
                  if(!_loc27_)
                  {
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1517);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_745.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_48);
            this.var_745.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_724);
