package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener
   {
      ...
      private var var_689:Point = null;
      ...
      {
         return [RoomWidgetChatMessage.const_627,RoomWidgetChatSelectAvatarMessage.const_833];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_627:
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_833:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc12_ = uint(this.var_858.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                 switch(_loc10_.type)
                                 {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          _loc13_ = _loc17_.getCroppedImage(AvatarSetType.const_44);
                                 ...
                                 if(_loc10_.type == RoomObjectTypeEnum.const_230)
                                 {
                                    if(_loc13_ != null)
                                    {
                                       this.var_374.add(_loc17_.getFigure().getFigureString(),_loc13_);
                                    }
                                 }
                                 else if(_loc13_ != null)
                                 {
                                    this.var_375.add(_loc16_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    this.var_858.add(_loc16_,_loc12_);
                                 }
                                 if(_loc17_ != null)
                                 {
                                    _loc17_.dispose();
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1057 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1057);
            }
            if(this.var_689 == null)
            {
               ...
               this.var_451.y = 0;
               this.var_451.z = 0;
               this.var_689 = _loc4_.getScreenPoint(this.var_451);
               this.var_1057 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_451.x = 0;
            this.var_451.y = 0;
            this.var_451.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_451);
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_689.x || _loc8_.y != this.var_689.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_689,_loc5_));
