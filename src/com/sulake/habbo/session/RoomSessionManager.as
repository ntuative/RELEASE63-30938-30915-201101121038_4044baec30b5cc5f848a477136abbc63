package com.sulake.habbo.session
{
   ...
   public class RoomSessionManager extends Component implements IRoomSessionManager, IRoomHandlerListener
   {
      ...
      private function initializeManager() : void
      {
         ...
         if(this.initialized && this.var_1577)
         {
            this.gotoRoom(this.var_2155,this.var_2153,this.var_1578);
            this.var_1577 = false;
            this.var_1578 = "";
         }
      }
      ...
      public function sessionUpdate(param1:int, param2:int, param3:String) : void
      {
         ...
         if(_loc4_ != null)
         {
            switch(param3)
            {
               case RoomSessionHandler.const_1126:
                  break;
               case RoomSessionHandler.const_1084:
                  break;
               case RoomSessionHandler.const_672:
