package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2770:String = "magic.credits";
      
      private var var_2739:String = "magic.pixels";
      
      private var var_2740:String = "catalog.page.club";
      ...
      {
         this.openPage(this.var_2739);
      }
      
      private function openClubPage() : void
      {
         this._catalog.openCatalogPage(this.var_2740,true);
      }
