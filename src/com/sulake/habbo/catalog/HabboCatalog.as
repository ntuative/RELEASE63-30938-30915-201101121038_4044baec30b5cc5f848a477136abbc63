package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private var var_315:ICatalogNavigator;
      ...
      private var var_277:ChargeConfirmationDialog;
      ...
      private var var_2164:Boolean = true;
      
      private var var_2163:Boolean = true;
      
      private var var_1582:Boolean = false;
      
      private var var_2165:GiftWrappingConfiguration;
      
      private var var_1031:ClubGiftController;
      
      private var var_447:ClubBuyController;
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "") : void
      {
         ...
         {
            this.var_447.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_315.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_368.method_4(param1);
         }
         return _loc3_;
      }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_106.getActivityPointsForType(Purse.const_416)));
         var _loc1_:int = 0;
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_315 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_215,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_80:
               this.var_1582 = param1.session.isPrivateRoom;
               if(this.var_87 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1031 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_447 == null)
         {
            this.var_447 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_315.buildCatalogIndex(_loc2_);
         if(this.var_680 && this.var_680 != "")
         {
            this.var_315.openPage(this.var_680);
            this.var_680 = "";
            this.var_841 = -1;
         }
         else if(this.var_841 > -1)
         {
            this.var_315.openPageById(this.var_841,this.var_1583);
            this.var_841 = -1;
            this.var_1583 = -1;
            this.var_680 = "";
         }
      ...
      private function onApproveNameResult(param1:ApproveNameMessageEvent) : void
      {
         ...
         this.var_316.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2164 && this.var_549 != null)
         {
            this.var_549.playSound(HabboSoundTypesEnum.const_1000);
         }
         this.var_2164 = false;
         if(this.var_277 != null)
         {
            this.var_277.refresh();
         }
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2163 && this.var_549 != null)
         {
            this.var_549.playSound(HabboSoundTypesEnum.const_1043);
         }
         this.var_2163 = false;
         if(this.var_277 != null)
         {
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1031.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2165 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_277 == null)
         {
            this.var_277 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_277.showChargeInfo(_loc2_);
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == this.var_166.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_166.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_174)
         {
            _loc3_ = this.var_166.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
