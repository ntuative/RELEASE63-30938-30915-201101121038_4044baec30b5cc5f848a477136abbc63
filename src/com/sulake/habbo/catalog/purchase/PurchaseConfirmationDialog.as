package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_1884:int = 10;
      ...
      private const const_1602:uint = 4.293848814E9;
      
      private const const_1603:uint = 4.294967295E9;
      
      private const const_1883:uint = 4.291613146E9;
         ...
         if(_loc2_ != null)
         {
            ...
            switch(_loc9_)
            {
               ...
               case ProductTypeEnum.const_78:
                  ...
                  break;
               case ProductTypeEnum.const_259:
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1631 = _loc1_.stuffTypes;
            this.var_692 = _loc1_.boxTypes;
            this.var_693 = _loc1_.ribbonTypes;
            this.var_1068 = this.var_1631[0];
            this.var_321 = this.var_692[0];
            this.var_320 = this.var_693[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_320 < 0)
         {
            this.var_320 = this.var_693.length - 1;
         }
         if(this.var_320 > this.var_693.length - 1)
         {
            this.var_320 = 0;
         }
         if(this.var_321 < 0)
         {
            this.var_321 = this.var_692.length - 1;
         }
         if(this.var_321 > this.var_692.length - 1)
         {
            this.var_321 = 0;
         }
         var _loc1_:int = this.var_692[this.var_321] * 1000 + this.var_693[this.var_320];
         if(this._window == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1631;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_79);
      ...
      private function giveGift() : void
      {
         ...
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_692[this.var_321]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_693[this.var_320]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_89,this.var_1309,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_89.offerId,this.var_1309);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_106:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(this.var_2256 == _loc3_.text)
               {
                  return;
               }
               ...
               for each(_loc7_ in this.var_210)
               {
                  ...
                  if(_loc5_.length >= this.const_1884)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2256 = _loc3_.text;
               break;
            case WindowMouseEvent.const_42:
               ...
               break;
            case WindowKeyboardEvent.const_377:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_322 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_322 + 1);
                     break;
      ...
      private function selectHighlighted() : void
      {
         ...
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_322) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_557 == null)
         {
            this.var_557 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_557.procedure = this.suggestionsEventHandler;
         }
         if(this.var_238 == null || this.var_557 == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_557.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_322) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_322);
         }
         this.var_322 = param1;
         if(this.var_322 < 0)
         {
            this.var_322 = _loc2_.numListItems - 1;
         }
         if(this.var_322 >= _loc2_.numListItems)
         {
            this.var_322 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_322) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1883;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1602) : uint(this.const_1603);
      }
