package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1061.removeEventListener(WindowKeyboardEvent.const_155,this.windowKeyEventProcessor);
         }
      }
      ...
      override public function init() : void
      {
         ...
         this.var_1061 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1061 != null)
         {
            this.var_1061.addEventListener(WindowKeyboardEvent.const_155,this.windowKeyEventProcessor);
         }
      }
