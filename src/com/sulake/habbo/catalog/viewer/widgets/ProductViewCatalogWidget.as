package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1831:Point;
      
      private var var_496:IItemGridWindow;
      
      private var var_1417:IScrollbarWindow;
      
      protected var var_1548:XML;
      
      private var var_2595:Array;
      ...
      {
         this.var_929 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1156 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_83 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1831 = new Point(this.var_83.x,this.var_83.y);
         this.var_496 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         ...
         this.var_1832 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_929.text = _loc4_;
         this.var_1156.text = _loc5_;
         this.var_929.height = this.var_929.textHeight + 5;
         this.var_1156.y = this.var_929.y + this.var_929.height;
         this.var_1156.height = Math.max(130,this.var_1156.textHeight + 5);
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_259:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              _loc16_.setDirection(AvatarSetType.const_44,3);
                              _loc16_.initActionAppends();
                              _loc16_.appendAction(AvatarAction.const_292,AvatarAction.const_545);
                              _loc16_.appendAction(AvatarAction.const_283,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2595)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2595 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_83 != null && true)
         {
            ...
            this.var_83.x = this.var_1831.x;
            this.var_83.y = this.var_1831.y;
            if(param3 != null)
            {
