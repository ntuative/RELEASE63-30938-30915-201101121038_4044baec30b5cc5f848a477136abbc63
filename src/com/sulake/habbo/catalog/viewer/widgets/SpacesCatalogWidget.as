package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1727:String = "default";
      ...
      private var var_1730:String = "1.1";
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1360[this.var_389];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1361[this.var_390];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1362[this.var_388];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1730);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this.var_897[this.var_389];
         ...
         for each(_loc1_ in this.var_166.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[this.var_476];
               if(_loc11_ != null)
               {
         ...
         _loc6_ = this.var_1361[this.var_390];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_899[this.var_388];
         for each(_loc1_ in this.var_166.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_475];
               if(_loc13_ != null)
               {
                  this.var_1730 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1362[this.var_388];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_195:
               ...
               if(this.var_389 < 0)
               {
                  this.var_389 = this.var_897.length - 1;
               }
               if(this.var_389 == this.var_897.length)
               {
                  this.var_389 = 0;
               }
               this.var_391 = 0;
               this.var_901 = 0;
               _loc5_ = this.var_897[this.var_389];
               for each(_loc8_ in this.var_166.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_901 = _loc8_.children().length();
                  }
               }
            ...
            case const_196:
               ...
               for each(_loc9_ in this.var_166.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_900 = _loc9_.children().length();
                  }
               }
            ...
            case const_91:
               ...
               if(this.var_388 < 0)
               {
                  this.var_388 = this.var_899.length - 1;
               }
               if(this.var_388 >= this.var_899.length)
               {
                  this.var_388 = 0;
               }
               this.var_475 = 0;
               this.var_898 = 0;
               _loc7_ = this.var_899[this.var_388];
               for each(_loc10_ in this.var_166.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_898 = _loc10_.children().length();
                  }
               }
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(this._floorType,this.var_1727,this.var_1730,64,this,"window_romantic_wide");
         ...
         {
            this.var_1729 = _loc2_.id;
            this.var_1728 = _loc3_.id;
