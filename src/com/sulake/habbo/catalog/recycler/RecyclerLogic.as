package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_888:int = 0;
      
      private static const const_397:int = 1;
      
      private static const const_889:int = 2;
      ...
      {
         return this.var_593 != const_888;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1746 != RecyclerStatusMessageEvent.const_1048;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_593 == const_397;
      }
      ...
      {
         this.var_593 = const_889;
         this.var_110 = new Array(const_187);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1746)
         {
            case RecyclerStatusMessageEvent.const_1484:
               this.var_593 = const_397;
               if(this._view == null)
               {
                  return;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1048:
               if(this._view == null)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_935:
               if(this._view != null)
               {
      ...
      {
         if(!this.ready || !this._catalog.include)
         {
            return false;
         }
      ...
      {
         if(!this._catalog.include && this.ready)
         {
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_110.length < const_187)
         {
            return false;
         }
         var _loc1_:int = 0;
