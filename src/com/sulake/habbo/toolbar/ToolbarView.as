package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_440:String = "LEFT";
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_198 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_55,HabboWindowStyle.const_1033,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1003 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1003)
         {
         ...
         this.var_1002 = _loc6_.toolbar.@margin_top;
         this.var_1251 = _loc6_.toolbar.@margin_bottom;
         this.var_1527 = _loc6_.toolbar.@min_group_margin;
         this.var_1526 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_279 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_227,param1,param2,this._window,this.var_279);
         this.createGroupsFromXmlList(_loc8_,this.var_539,param1,param2,this.var_198,this.var_279);
         this.alignWindows();
      }
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_139,this.var_440,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_440);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_139,this.var_440);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_139,this.var_440);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_539.length)
         {
            _loc2_ = this.var_539[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_198.x = this.var_139 + this.var_1526;
               this.var_198.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_198.x = 0;
               this.var_198.y = this.var_139 + this.var_1526;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1002;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_227.length > 1)
            {
               if(this.orientation == "LEFT" || this.orientation == "RIGHT")
               {
                  _loc6_ = Number(Math.max(this.var_1527,(this._window.height - _loc5_ * _loc8_ - this.var_1002 - this.var_1251) / (this.var_227.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1527,(this._window.width - _loc5_ * _loc8_ - this.var_1002 - this.var_1251) / (this.var_227.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_227.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_440;
