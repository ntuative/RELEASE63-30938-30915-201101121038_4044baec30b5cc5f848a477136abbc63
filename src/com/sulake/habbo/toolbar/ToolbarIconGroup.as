package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_552:ToolbarBarMenuAnimator;
      ...
      private var var_2182:int = 5;
      
      private var var_2312:int;
      
      private var var_139:Number;
      
      private var var_2313:XML;
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2313.elements("menu");
         var _loc5_:int = 0;
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_709.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      private function alignItems() : void
      {
         ...
         {
            _loc2_ = this.var_709.indexOf(this.var_1330[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_286[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1089 + _loc3_);
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_286[this.var_709.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,this._windowManager,this._assetLibrary,param1,this._events,this.var_552);
         this.var_36.addChild(_loc2_.window);
