package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_885:Array = [];
      
      private static var var_1691:int = 1000;
      
      private static var var_884:Array = [];
      
      private static var var_1690:int = 200;
      ...
      private var var_1589:IMessageComposer;
      ...
      {
         this.var_716 = IWindowContainer(this.var_33.getXmlWindow("chatlog_roomheader"));
         this.var_715 = IWindowContainer(this.var_33.getXmlWindow("chatlog_chatline"));
         ...
         this.var_33.connection.send(this.var_1589);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_885.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_715.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_885.length < var_1691)
         {
            ...
            param1.width = this.var_715.width;
            param1.height = this.var_715.height;
            var_885.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1689[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1344.getValue(param2.chatterName))
            {
               this.var_1344.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1344.getValue(_loc2_);
