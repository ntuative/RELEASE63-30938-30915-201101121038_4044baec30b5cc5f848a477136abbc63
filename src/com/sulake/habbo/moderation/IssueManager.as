package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_974:String = "issue_bundle_open";
      
      public static const const_656:String = "issue_bundle_my";
      
      public static const const_1062:String = "issue_bundle_picked";
      
      public static const const_1415:int = 15000;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_615 = new IssueBrowser(this,this.var_60.windowManager,this.var_60.assets);
         this.var_1153 = [];
         this.var_1154 = [];
         this.var_926 = new Map();
         this.var_2580 = parseInt(this.var_60.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1818 = new Timer(const_1415,0);
         this.var_1818.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1818.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.sendPick(_loc4_.method_5(),param2,param3);
         this.var_1153 = this.var_1153.concat(_loc4_.method_5());
      }
      ...
      public function releaseAll() : void
      {
         ...
         for each(_loc3_ in this.var_98)
         {
            ...
            {
               _loc2_ = _loc2_.concat(_loc3_.method_5());
            }
         }
      ...
      public function releaseBundle(param1:int) : void
      {
         ...
         this.sendRelease(_loc2_.method_5());
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         {
            this.var_60.soundManager.playSound(HabboSoundTypesEnum.const_943);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_927.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_927.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1465)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_98)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_927.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2581++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_927.add(param1.issueId,_loc2_);
         ...
         if(this.var_1153.indexOf(param1.issueId) != -1)
         {
         ...
         {
            _loc6_ = this.getBundles(const_656);
            _loc7_ = false;
            ...
            _loc9_ = this.var_1154.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2580);
            }
         }
      ...
      {
         var _loc2_:IssueHandler = this.var_926.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      {
         var _loc2_:* = this.var_926.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_927.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_98.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function handleBundle(param1:int) : void
      {
         ...
         this.var_926.add(param1,_loc3_);
      ...
      public function unhandleBundle(param1:int) : void
      {
         ...
         var _loc3_:IssueHandler = this.var_926.remove(param1);
         if(_loc3_ != null)
         {
            _loc3_.dispose();
         }
      ...
      public function closeBundle(param1:int, param2:int) : void
      {
         ...
         this.sendClose(_loc3_.method_5(),param2);
      }
      ...
      public function issuePickFailed(param1:Array) : Boolean
      {
         ...
         for each(_loc4_ in param1)
         {
            ...
            {
               _loc12_ = _loc8_.id;
               _loc13_ = this.var_926.getValue(_loc12_) as IssueHandler;
               if(_loc13_ != null)
               {
                  _loc13_.dispose();
               }
