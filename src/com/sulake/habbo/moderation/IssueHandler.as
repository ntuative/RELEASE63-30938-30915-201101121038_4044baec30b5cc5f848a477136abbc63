package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_149:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_488:UserInfoCtrl;
      
      private var var_1144:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_149.getHighestPriorityIssue();
         this.var_488 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
         this.var_1144 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
         this.var_488.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_149.reportedUserId > 0)
         {
            this.var_1144.load(_loc4_,this.var_149.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_149.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_149.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_60 != null && this.var_60.issueManager != null && this.var_149 != null)
         {
            this.var_60.issueManager.removeHandler(this.var_149.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_149.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_149.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_149.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.releaseBundle(this.var_149.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_149.getHighestPriorityIssue().issueId;
         this.var_60.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_60,WindowTracker.const_1079,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_149.getHighestPriorityIssue();
            this.var_488 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
