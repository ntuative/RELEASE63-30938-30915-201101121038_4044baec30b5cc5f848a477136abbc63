package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1881:String = "my_issues";
      
      private const const_1882:String = "open_issues";
      
      private const const_1880:String = "picked_issues";
      
      private const const_1916:String = "closed_issues";
      ...
      private var var_319:IIssueBrowserView;
      
      private var var_1619:IIssueBrowserView;
      
      private var var_1618:IIssueBrowserView;
      
      private var var_1617:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_236 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_236.numTabItems)
            {
               _loc5_ = this.var_236.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_54,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_236 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_236 == null || this.var_236.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_236.selector.getSelectableByName("open_issues");
         this.var_236.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_319 == _loc2_)
         {
            return;
         }
         ...
         this.var_319.view.width = this.var_236.container.width;
         this.var_319.view.height = this.var_236.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1881:
               ...
               {
                  this.var_1619 = new MyIssuesView(this.issueManager,this,this.var_236.container);
               }
               return this.var_1619;
            case this.const_1882:
               if(this.var_1618 == null)
               {
                  this.var_1618 = new OpenIssuesView(this.issueManager,this,this.var_236.container);
               }
               return this.var_1618;
            case this.const_1880:
               if(this.var_1617 == null)
               {
                  this.var_1617 = new PickedIssuesView(this.issueManager,this,this.var_236.container);
               }
