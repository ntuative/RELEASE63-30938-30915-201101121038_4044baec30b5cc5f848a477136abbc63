package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_803:Array = [];
      
      private static var var_1483:int = 200;
      ...
      {
         this.var_648 = IWindowContainer(this.var_33.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1311;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_803.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_648.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_803.length < var_1483)
         {
            ...
            param1.width = this.var_648.width;
            param1.height = this.var_648.height;
            var_803.push(param1);
         }
         else
         {
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1219)
         {
