package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1030:IDropMenuWindow;
      ...
      private var var_840:OffenceCategoryData;
      
      private var var_839:OffenceData;
      
      private var var_1029:IButtonWindow;
      
      private var var_1028:IButtonWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1029 = IButtonWindow(this.var_33.getXmlWindow("modact_offence"));
         this.var_1028 = IButtonWindow(this.var_33.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1462;
         ...
         this.var_1030 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1030);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_840 != null;
         if(this.var_839 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_839.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_840 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_840.offences,this.var_1029,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_33.initMsg.offenceCategories,this.var_1028,this.onOffenceCtgButton);
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModAlertMessageComposer(this.var_1284,this.var_446.text,this.var_1283));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_840 = this.var_33.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_839 = this.var_840.offences[_loc3_];
         this.var_446.text = this.var_839.msg;
         this.var_589 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_33.connection.send(new ModKickMessageComposer(this.var_1284,this.var_446.text,this.var_1283));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1030.selection < 0)
         {
            this.var_33.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_33.connection.send(new ModBanMessageComposer(this.var_1284,this.var_446.text,this.getBanLength(),this.var_1283));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1030.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1029.destroy();
            this.var_1029 = null;
         }
         if(this.var_1028 != null)
         {
            this.var_1028.destroy();
            this.var_1028 = null;
         }
         this.var_1030 = null;
         this.var_446 = null;
