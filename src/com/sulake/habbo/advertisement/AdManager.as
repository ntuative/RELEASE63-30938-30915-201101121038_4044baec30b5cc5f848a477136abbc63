package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2069 = this._config.getKey("interstitial.enabled","false") == "true";
         this.var_2070 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_2071 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_1506 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_988 == 0)
         {
            this.var_988 = getTimer();
            return false;
         }
         if(this.var_1506 > 0 && this.var_1505 >= this.var_1506)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_988;
         if(_loc1_ > this.var_2070)
         {
            ++this.var_1505;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         if(this.var_1239 != "")
         {
            ...
            {
               this.var_196 = new Timer(this.var_2071,1);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_490,0,0,param1.bitmapData,this.var_2068));
            this.var_988 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_422));
         }
      }
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         this.var_1504 = _loc2_.clickUrl;
         if(this.var_1240 != "" && this.var_1504 != "")
         {
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_426,0,0,_loc4_,this.var_1504,this.var_989,this.var_990));
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_990 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
