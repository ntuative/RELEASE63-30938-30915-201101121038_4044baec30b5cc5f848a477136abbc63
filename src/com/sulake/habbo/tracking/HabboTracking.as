package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_885:uint = 11;
      ...
      private var var_1078:IHabboWindowManager;
      ...
      private var var_562:FramerateTracker = null;
      
      private var var_240:LatencyTracker = null;
      
      private var var_561:LagWarningLogger = null;
      
      private var var_563:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_241 = new PerformanceTracker();
         this.var_562 = new FramerateTracker();
         this.var_240 = new LatencyTracker();
         this.var_561 = new LagWarningLogger();
         this.var_563 = new ToolbarClickTracker(this);
         this.var_1318 = new Array(const_885);
         var _loc4_:int = 0;
         while(_loc4_ < const_885)
         {
            this.var_1318[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1339,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1411,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1396,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_580,String(false));
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1078)
            {
               this.var_1078.release(new IIDHabboWindowManager());
               this.var_1078 = null;
            }
            if(this.var_288)
            {
            ...
            if(this.var_183)
            {
               if(!this.var_183.disposed)
               {
                  ...
                  Component(this.var_183).events.removeEventListener(HabboFriendListTrackingEvent.const_333,this.onFriendlistTrackingEvent);
               }
      ...
      {
         this.var_1318[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_166 = IHabboConfigurationManager(param2);
         if(this.var_166)
         {
            if(this.var_240 != null)
            {
               this.var_240.configuration = this.var_166;
            }
            if(this.var_241 != null)
            {
               this.var_241.configuration = this.var_166;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1495);
            if(this.var_166)
            {
               if(this.var_561 != null)
               {
                  this.var_561.configure(this.var_166);
               }
               if(this.var_562 != null)
               {
                  this.var_562.configure(this.var_166);
               }
               if(this.var_563 != null)
               {
                  this.var_563.configure(this.var_166);
               }
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.trackLoginStep(HabboLoginTrackingStep.const_146);
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_689,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_232,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_185,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_176,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_257,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_221,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_775,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_241 != null)
            {
               this.var_241.connection = param1;
            }
            if(this.var_240 != null)
            {
               this.var_240.communication = this._communication;
               this.var_240.connection = param1;
            }
            if(this.var_561 != null)
            {
               this.var_561.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_775)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1459);
         }
         else if(param1.type == HabboHotelViewEvent.const_500)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1302);
         }
         else if(param1.type == HabboHotelViewEvent.const_64)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1338);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1384);
               break;
            case HabboCommunicationEvent.const_689:
               this.trackLoginStep(HabboLoginTrackingStep.const_1353,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_232:
               this.trackLoginStep(HabboLoginTrackingStep.const_232);
               break;
            case HabboCommunicationEvent.const_176:
               this.trackLoginStep(HabboLoginTrackingStep.const_176);
               break;
            case HabboCommunicationEvent.const_185:
               this.setErrorContextFlag(2,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_185);
               break;
            case HabboCommunicationEvent.const_257:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_257);
               if(this.var_240 != null)
               {
                  this.var_240.init();
               }
      ...
      {
         this.var_1078 = IHabboWindowManager(param2);
         if(this.var_1078)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_166)
            {
               if(this.var_166.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_166.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1318)
                  {
                  ...
                  if(this.var_241 != null)
                  {
                     _loc4_["null"] = this.var_241.flashVersion;
                     _loc4_["null"] = this.var_241.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1074);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1074,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_183).events.addEventListener(HabboFriendListTrackingEvent.const_333,this.onFriendlistTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2277)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1337);
            this.var_2277 = true;
         }
         ...
         if(_loc2_.guestRoom)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_580,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_302,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_288 = param2 as IAdManager;
         this.var_288.events.addEventListener(AdEvent.const_426,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_563)
         {
            this.var_563.track(param1.iconName);
         }
      }
      ...
      {
         if(this.var_166 != null && !Boolean(this.var_166.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_561.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1655;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1655);
         }
         if(this.var_462 > -1 && _loc2_ - this.var_462 > 15000)
         {
            ++this.var_1654;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1654);
         }
         this.var_462 = _loc2_;
         if(this.var_241 != null)
         {
            this.var_241.update(param1,this.var_462);
         }
         if(this.var_240 != null)
         {
            this.var_240.update(param1,this.var_462);
         }
         if(this.var_562 != null)
         {
            this.var_562.trackUpdate(param1,this,this.var_462);
         }
         if(this.var_561 != null)
         {
            this.var_561.update(this.var_462);
         }
      }
   }
}
