package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      public function init() : void
      {
         ...
         this.var_1532 = int(this.var_166.getKey("latencytest.interval"));
         this.var_1530 = int(this.var_166.getKey("latencytest.report.index"));
         this.var_2113 = int(this.var_166.getKey("latencytest.report.delta"));
      ...
      public function update(param1:uint, param2:int) : void
      {
         ...
         if(param2 - this.var_1531 > this.var_1532)
         {
            this.testLatency();
         }
      }
      ...
      private function testLatency() : void
      {
         ...
         this.var_541.add(this.var_1256,this.var_1531);
         this._connection.send(new LatencyPingRequestMessageComposer(this.var_1256));
         ++this.var_1256;
      }
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var _loc10_:int = 0;
         var _loc11_:* = null;
         if(this.var_541 == null || this.var_199 == null)
         {
            return;
         }
         var _loc2_:LatencyPingResponseMessageParser = (param1 as LatencyPingResponseMessageEvent).getParser();
         var _loc3_:int = this.var_541.getValue(_loc2_.requestId);
         this.var_541.remove(_loc2_.requestId);
         var _loc4_:int = getTimer() - _loc3_;
         this.var_199.push(_loc4_);
         if(this.var_199.length == this.var_1530 && this.var_1530 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - this.var_1533) > this.var_2113 || this.var_1533 == 0)
            {
