package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_550:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1032,param1);
         this.var_842 = param1;
         if(param2)
         {
      ...
      {
         return int(this.var_1523 * (Number(param1 - this._minValue) / (this.var_1032 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1523 * (this.var_1032 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_843)
         {
            if(param1.type == WindowMouseEvent.const_57 || param1.type == WindowMouseEvent.const_208)
            {
               this.var_843 = false;
            }
         }
         if(!this.var_843 || param1.type != WindowEvent.const_338)
         {
            return;
         }
         if(this.var_550 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_550) * this.var_550;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_550 != 0)
            {
               _loc3_ = this.var_842 + this.var_550;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_664 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_664.width,this.var_664.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_664,this.var_664.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1523 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_664 = BitmapData(_loc2_.content);
      }
   }
}
