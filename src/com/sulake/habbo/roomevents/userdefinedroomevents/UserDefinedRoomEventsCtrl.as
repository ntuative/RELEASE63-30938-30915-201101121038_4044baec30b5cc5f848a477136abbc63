package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1511:TriggerConfs;
      
      private var var_1512:ActionTypes;
      
      private var var_1510:ConditionTypes;
      
      private var var_226:Dictionary;
      
      private var var_58:Triggerable;
      
      private var var_659:RoomObjectHightLighter;
      ...
      {
         this.var_1511 = new TriggerConfs();
         this.var_1512 = new ActionTypes();
         this.var_1510 = new ConditionTypes();
         this.var_226 = new Dictionary();
         super();
         this.var_85 = param1;
         this.var_659 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_226[param1];
            this.var_659.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_58.furniLimit)
         {
            this.var_226[param1] = param2;
            this.var_659.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_992 = new SliderWindowController(this.var_85,IWindowContainer(this.find(this.var_86,"delay_slider_container")),this.var_85.assets,0,20,1);
         this.var_992.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_992.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_659.hideAll(this.var_226);
         }
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_58 as TriggerDefinition != null)
         {
            this.var_85.send(new UpdateTriggerMessageComposer(this.var_58.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         else if(this.var_58 as ActionDefinition != null)
         {
            this.var_85.send(new UpdateActionMessageComposer(this.var_58.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay()));
         }
         else if(this.var_58 as ConditionDefinition != null)
         {
            this.var_85.send(new UpdateConditionMessageComposer(this.var_58.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds()));
         }
         this.close();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_992.getValue()) : 0;
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_85.send(new ApplySnapshotMessageComposer(this.var_58.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1511);
         this.refreshConfigureElement(this.var_1512);
         this.refreshConfigureElement(this.var_1510);
