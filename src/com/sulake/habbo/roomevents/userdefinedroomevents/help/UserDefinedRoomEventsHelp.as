package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private var var_1074:IContainerButtonWindow;
      
      private var var_1075:IContainerButtonWindow;
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1650 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1075 = this.var_1650.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1075)
         {
            this.var_1075.procedure = this.onButtonClick;
         }
         this.var_1074 = this.var_1650.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1074)
         {
            this.var_1074.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_239 >= this._localizations.length - 1)
         {
            this.var_1074.disable();
         }
         else
         {
            this.var_1074.enable();
         }
         if(this.var_239 <= 0)
         {
            this.var_1075.disable();
         }
         else
         {
            this.var_1075.enable();
         }
      }
      ...
      {
         ++this.var_239;
         this.var_239 = Math.min(this.var_239,this._localizations.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_239;
         this.var_239 = Math.max(this.var_239,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this._localizations[this.var_239][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this._localizations[this.var_239][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this._localizations[this.var_239][1]).value;
