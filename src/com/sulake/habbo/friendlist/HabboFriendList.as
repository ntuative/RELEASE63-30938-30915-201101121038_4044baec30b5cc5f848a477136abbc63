package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_144:String = "face";
      ...
      private var var_972:IAvatarRenderManager;
      
      private var var_645:ISessionDataManager;
      
      private var var_2011:FriendListLookAndFeel;
      
      private var var_409:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1478:OpenedToWebPopup;
      
      private var var_2010:int;
      
      var var_92:FriendCategories;
      
      private var var_302:FriendRequests;
      
      private var var_1477:AvatarSearchResults;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_880:IHabboNotifications;
      
      private var var_526:Timer;
      
      public function HabboFriendList(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2011 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_92 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1477 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_526.stop();
            this.var_526.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_526 = null;
         }
         ...
         if(this.var_972)
         {
            this.var_972.release(new IIDAvatarRenderManager());
            this.var_972 = null;
         }
         if(this.var_880)
         {
            this.var_880.release(new IIDHabboNotifications());
            this.var_880 = null;
         }
         if(this._toolbar)
         {
         ...
         if(this.var_645)
         {
            this.var_645.release(new IIDSessionDataManager());
            this.var_645 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1478 = new OpenedToWebPopup(this);
         }
         this.var_1478.show(x,y);
      }
      ...
      public function refreshToolBarIcon() : void
      {
         ...
         _loc1_.iconState = String(this.var_302.getCountOfOpenRequests() > 0 ? "2" : "0");
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_309,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_972.createAvatarImage(param1,AvatarScaleType.const_82,null,this);
         if(!_loc2_)
         {
            return null;
         }
         var _loc3_:BitmapData = _loc2_.getCroppedImage(AvatarSetType.const_44);
         _loc2_.dispose();
         return _loc3_;
      }
      ...
      {
         var _loc1_:String = this.var_166.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_166.getKey(param1,param1,param2);
      }
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_972 = param2 as IAvatarRenderManager;
      ...
      {
         this.var_880 = param2 as IHabboNotifications;
      ...
      {
         this.var_645 = param2 as ISessionDataManager;
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_302 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit,_loc2_.evenMoreExtendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            this.var_92.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         this.var_92.addCategory(new FriendCategory(FriendCategory.const_1101,this.getText("friendlist.friends")));
         this.var_92.addCategory(new FriendCategory(FriendCategory.const_361,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_92.addFriend(new Friend(_loc4_));
         }
         this.var_409 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_526)
         {
            this.var_526 = new Timer(120000);
            this.var_526.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_526.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_92.findCategory(FriendCategory.const_361);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_409.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         this.var_302.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            this.var_302.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            this.var_409.findTab(FriendListTab.const_88).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         this.var_302.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = this.var_409.findTab(FriendListTab.const_88);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1477.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_409.findTab(FriendListTab.const_88);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_645 || !this.var_302)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_645.hasUserRight("fuse_super_extended_buddylist"))
         {
            _loc2_ = this.var_302.vipLimit;
         }
         else if(this.var_645.hasUserRight("fuse_extended_buddylist"))
         {
            _loc2_ = this.var_302.clubLimit;
         }
         if(_loc2_ > this.var_302.limit)
         {
            this.var_302.limit = _loc2_;
         }
      }
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face)
               {
                  _loc4_ = _loc3_.view.getChildByName(const_144) as IBitmapWrapperWindow;
