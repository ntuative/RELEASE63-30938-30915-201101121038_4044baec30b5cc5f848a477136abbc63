package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1835:int = "F".charCodeAt(0);
      
      public static const const_1800:int = "M".charCodeAt(0);
      ...
      private var var_1160:BitmapData;
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_938 = param1.gender;
         this.var_718 = param1.online;
         this.var_1633 = param1.followingAllowed && param1.online;
         this.var_620 = param1.figure;
         this.var_1845 = param1.motto;
         this.var_1701 = param1.lastAccess;
         this.var_1296 = param1.categoryId;
