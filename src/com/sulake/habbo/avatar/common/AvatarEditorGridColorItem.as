package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_799:IPartColor;
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_708 = _loc4_.content as BitmapData;
         ...
         this.var_798 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_708.width,this.var_708.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_708,this.var_708.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_975.width,this.var_975.height,true,0);
            _loc5_ = this.var_975.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_799.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_798.width,this.var_798.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_798,this.var_798.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
         ...
         if(_loc4_)
         {
            if(this.var_799)
            {
               switch(this.var_799.clubLevel)
               {
                  case HabboClubLevelEnum.const_49:
                     _loc4_.visible = false;
                     break;
                  case HabboClubLevelEnum.const_59:
                     _loc4_.style = HabboIconType.const_835;
                     _loc4_.visible = true;
                     break;
                  case HabboClubLevelEnum.const_50:
                     _loc4_.style = HabboIconType.const_770;
                     _loc4_.visible = true;
               }
            }
            else
