package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_534:Rectangle;
      
      private var var_1515:int = 0;
      
      private var var_367:IAvatarRenderManager;
      
      private var var_723:Boolean;
      
      private var var_1516:BitmapData;
      
      private const const_1873:int = 13421772;
      
      private const const_1874:int = 16777215;
      
      private const const_317:Array = [2,6,0,4,3,1];
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_637 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1515 = Math.max(this.var_1515,_loc6_.colorLayerIndex);
            }
         }
         this.var_367 = this.var_62.controller.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_637 != null && !this.var_1517)
            {
               _loc3_ = this.var_637;
            }
            else
            ...
            if(this.var_661)
            {
               switch(this.var_661.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_59:
                     _loc2_.style = HabboIconType.const_835;
                     break;
                  case HabboClubLevelEnum.const_50:
                     _loc2_.style = HabboIconType.const_770;
               }
            }
            else
            {
         ...
         if(this.isSelected)
         {
            this._window.color = this.const_1873;
         }
         else
         {
            this._window.color = this.const_1874;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         var _loc1_:AvatarFigureContainer = this.var_367.createFigureContainer(this.partSet.type + "-" + this.partSet.id);
         Logger.log("QUERYING SET:" + this.partSet.type + "-" + this.partSet.id);
         if(!this.var_367.isFigureReady(_loc1_))
         {
            this.var_367.downloadFigure(_loc1_,this);
            return false;
         }
         var _loc6_:int = 0;
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_317[_loc6_] + "_" + FigureData.const_140;
               _loc4_ = this.var_367.getAssetByName(_loc3_) as BitmapDataAsset;
            }
            else
            {
               _loc6_ = 0;
               while(!_loc7_ && _loc6_ < this.const_317.length)
               {
                  _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_317[_loc6_] + "_" + FigureData.const_140;
                  _loc4_ = this.var_367.getAssetByName(_loc3_) as BitmapDataAsset;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_534 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1516)
               {
                  ...
                  this.var_1516 = _loc9_.content as BitmapData;
               }
         ...
         _loc1_ = new BitmapData(this.var_534.width,this.var_534.height,true,16777215);
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               _loc10_ = -1 * _loc4_.offset.x - this.var_534.x;
               _loc11_ = -1 * _loc4_.offset.y - this.var_534.y;
               if(this.var_1517 && _loc2_.colorLayerIndex > 0)
               {
