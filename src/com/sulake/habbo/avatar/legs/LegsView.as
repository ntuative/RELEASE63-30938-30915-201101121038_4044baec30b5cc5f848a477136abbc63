   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_35)
         {
            ...
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.const_246,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.const_253,_windowManager,_assetLibrary);
         }
         else
         {
