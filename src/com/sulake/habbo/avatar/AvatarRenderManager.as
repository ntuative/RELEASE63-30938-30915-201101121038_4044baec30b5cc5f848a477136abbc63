package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_1885:String = "hd-99999-99999";
      ...
      private var var_1640:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_629 = RenderMode.const_1422;
         ...
         this.var_96.add(AvatarType.const_113,_loc4_);
         ...
         this.var_96.add(AvatarType.const_66,_loc4_);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_324.init();
         this.var_696.init();
         _loc2_ = this.var_96.getValue(AvatarType.const_113) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_96.getValue(AvatarType.const_66) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_96.getValue(AvatarType.const_113) as AvatarStructure;
            if(_loc3_ != null)
            {
               _loc4_ = this.var_166.getKey("external.figurepartlist.txt","figure.xml");
               ...
               if(this.var_206 == null)
               {
                  ...
                  _loc6_ = this.var_166.getKey("flash.dynamic.avatar.download.configuration","figuremap.xml");
                  _loc7_ = this.var_166.getKey("flash.dynamic.avatar.download.url","");
      ...
      private function checkIfReady() : void
      {
         if(!this.var_867)
         {
            if(this.var_2267 && this.var_2265 && this.var_2266)
            {
      ...
      {
         var _loc5_:AvatarStructure = this.var_96.getValue(AvatarType.const_113) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(!this.var_1640)
         {
            this.var_1640 = new AvatarFigureContainer(this.const_1885);
         }
         this.var_206.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1640,param2);
      }
      ...
      public function removePetImageListener(param1:IPetImageListener) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:int = 0;
         if(param1 == null || this.var_280 == null)
         {
            return;
         }
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_280.getKeys())
         {
            _loc4_ = this.var_280.getValue(_loc3_);
            if(_loc4_ != null)
            {
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         ...
         var _loc8_:AvatarStructure = this.var_96.getValue(AvatarType.const_66) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
         ...
         if(param5 != null)
         {
            ...
            this.var_280.add(_loc7_,_loc9_);
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_96.getValue(AvatarType.const_66);
         _loc2_.initFigureData(_loc1_);
         _loc2_.resetPartOffsets(context.assets);
         var _loc5_:Array = this.var_280.getKeys();
         for each(_loc6_ in _loc5_)
         {
            _loc4_ = this.var_280.getValue(_loc6_);
            if(_loc4_)
            {
      ...
      {
         var _loc3_:AvatarStructure = this.var_96.getValue(AvatarType.const_113) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_66:
               _loc3_ = this.var_96.getValue(AvatarType.const_66) as AvatarStructure;
               break;
            default:
