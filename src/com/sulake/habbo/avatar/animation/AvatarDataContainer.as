package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1835:Number = 1.0;
      ...
      {
         super();
         this.var_1745 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2445 = parseInt(_loc2_,16);
         this.var_2443 = parseInt(_loc3_,16);
         ...
         this.var_1519 = new ColorTransform(this.var_1835,this.var_1836,this.var_1837,this._alphaMultiplier);
         this.var_1119 = this.generatePaletteMapForGrayscale(this.var_2443,this.var_2445);
      }
      ...
      {
         return this.var_1119.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1119.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1119.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1119.getValue("alphas") as Array;
      }
