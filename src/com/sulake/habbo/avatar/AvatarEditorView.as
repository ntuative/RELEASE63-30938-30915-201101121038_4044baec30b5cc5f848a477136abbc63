package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1187:IWindowContainer;
      
      public static var var_1449:IWindowContainer;
      
      public static var var_1912:int = 6710886;
      ...
      private var var_510:ITabSelectorWindow;
      ...
      private var var_2678:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1184 = [];
         this.var_1387 = [AvatarEditorFigureCategory.const_801,AvatarEditorFigureCategory.const_44,AvatarEditorFigureCategory.const_200,AvatarEditorFigureCategory.const_625,AvatarEditorFigureCategory.const_962,AvatarEditorFigureCategory.const_96];
         super();
         ...
         if(var_1187 == null)
         {
            ...
            var_1187 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1449 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1449 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_414 = new Timer(1000);
         this.var_414.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1387;
         }
         for each(_loc6_ in param4)
         {
            this.var_1184.push(_loc6_);
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1387);
         }
         if(param1.length != this.var_1184.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1184.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2678 = this.canChangeOutfit();
            this.var_414.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_510 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_510.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_510.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1184.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_510.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_510.numSelectables)
               {
                  this.var_510.getSelectableAt(_loc6_).x = this.var_510.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1387;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1894 == AvatarEditorSideCategory.const_96 || this.var_2677))
         {
         ...
         this.setViewToCategory(this.var_336);
      }
      ...
      {
         if(this.var_1894 == AvatarEditorSideCategory.const_96)
         {
            this.var_2677 = false;
            this.setSideContent(AvatarEditorSideCategory.const_759);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_759:
               break;
            case AvatarEditorSideCategory.const_479:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_479);
               break;
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_336 = param1;
         this.var_510.setSelected(this.var_510.getSelectableByName(param1));
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_511)
         {
            ...
            this.var_511 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_511.procedure = this.stripClubDialogEventProc;
            this.var_511.center();
         }
         else
         {
