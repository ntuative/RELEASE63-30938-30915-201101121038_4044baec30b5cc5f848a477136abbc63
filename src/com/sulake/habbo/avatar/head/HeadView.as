   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_35)
         {
            ...
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.const_168,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.const_237,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.const_252,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.const_229,_windowManager,_assetLibrary);
            var_35["null"] = new AvatarEditorGridView(var_62,FigureData.const_201,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_62 && var_129 == "")
         {
            var_62.switchCategory(FigureData.const_168);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_hair":
                  this.switchCategory(FigureData.const_168);
                  break;
               case "tab_hat":
