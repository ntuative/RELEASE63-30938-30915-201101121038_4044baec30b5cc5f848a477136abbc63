package com.sulake.habbo.avatar
{
   ...
   public class PlaceholderPetImage extends PetImage
   {
      ...
      public function PlaceholderPetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:IAssetLibrary)
      {
         ...
         if(_loc6_)
         {
            this.var_42 = new BitmapData(_loc6_.width,_loc6_.height,true,16777215);
         }
      }
      ...
      override public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(!_loc3_ || !this.var_42)
         {
            return null;
         }
         this.var_42.fillRect(this.var_42.rect,16777215);
         this.var_42.copyPixels(_loc3_,_loc3_.rect,new Point((this.var_42.width - _loc3_.width) / 2,this.var_42.height - _loc3_.height),null,null,true);
         if(param2)
         {
      ...
      private function getPlaceHolderImage(param1:int, param2:String) : BitmapData
      {
         ...
         _loc3_ += "_png";
         _loc6_;
         var _loc4_:BitmapData = this.var_584.getValue(_loc3_);
         if(!_loc4_)
         {
            ...
            _loc6_;
            this.var_584.add(_loc3_,_loc4_.clone());
            _loc4_ = this.var_584.getValue(_loc3_);
         }
         return _loc4_;
      }
