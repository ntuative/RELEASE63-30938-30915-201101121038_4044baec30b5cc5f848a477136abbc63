package com.sulake.habbo.avatar.generic
{
   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      private const const_571:String = "tab_boy";
      
      private const const_572:String = "tab_girl";
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_62.controller.gender)
         {
            case FigureData.const_69:
               activateTab(this.const_571);
               inactivateTab(this.const_572);
               break;
            case FigureData.FEMALE:
               activateTab(this.const_572);
               inactivateTab(this.const_571);
         }
      }
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_571:
                  var_62.controller.gender = FigureData.const_69;
