package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_225:AvatarImageCache;
      
      private var var_533:int = 0;
      
      private var var_1507:int = 0;
      
      private var var_620:AvatarFigureContainer;
      
      private var var_532:Boolean;
      
      private var var_188:Array;
      
      private var var_517:IAvatarDataContainer;
      ...
      public function PetImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String)
      {
         ...
         this.var_620 = new AvatarFigureContainer(param3);
         var _loc5_:int = this.var_620.getPartSetId("pbd");
         this.solvePetAvatarTypeAndBreed(_loc5_);
         this.var_1327 = this.var_1328;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_44)
         {
            if((this.var_84 == 6 || this.var_84 == 0) && param2 == 7)
            {
               param2 = this.var_84;
            }
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1327);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_42 == null || _loc4_ != null && (this.var_42.width != _loc4_.width || this.var_42.height != _loc4_.height))
         {
            ...
            this.var_42 = new BitmapData(_loc4_.width,_loc4_.height,true,16777215);
         }
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc9_ = _loc3_.getImageContainer(_loc8_,this.var_533);
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc15_ = this._structure.getParts(_loc8_,this.var_620,_loc13_,"pet",_loc12_.getDirection(),[]);
               _loc16_ = this.var_1327 < 3;
               ...
               {
                  _loc18_ = _loc15_[0];
                  _loc19_ = _loc18_.getFrameIndex(this.var_533);
                  _loc20_ = this.var_84;
                  _loc21_ = 1;
                  switch(this.var_84)
                  {
               ...
               this.var_42.copyPixels(_loc10_,_loc10_.rect,_loc11_.add(_loc6_),null,null,true);
            }
            _loc7_--;
         }
         this.var_42.unlock();
         ...
         if(this.var_517 != null)
         {
            ...
            {
               _loc23_ = this.convertToGrayscale(this.var_42);
               if(this.var_42)
               {
                  this.var_42.dispose();
               }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc7_ >= 0)
         {
            ...
            _loc10_ = _loc2_.getImageContainer(_loc9_,this.var_533);
            if(_loc10_ != null)
            {
               ...
               _loc16_ = this._structure.getParts(_loc9_,this.var_620,_loc14_,"pet",_loc13_.getDirection(),[]);
               _loc17_ = 32;
               if(this._scale == AvatarScaleType.const_82)
               {
                  _loc17_ = 6;
               ...
               {
                  _loc19_ = _loc16_[0];
                  _loc20_ = _loc19_.getFrameIndex(this.var_533);
                  _loc21_ = this.var_84;
                  _loc22_ = 1;
                  switch(this.var_84)
                  {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_436 = this.var_436 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_296.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_874);
         this.getCache().resetBodyPartCache(this.var_874);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1326 = this._structure.sortActions(this.var_296);
         ...
         {
            this.var_639 = this._structure.getCanvasOffsets(this.var_1326,this._scale,this.var_84);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_1326)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_341)
               {
                  this.var_786 = true;
               }
               ...
               if(_loc1_.actionType == AvatarAction.const_273)
               {
                  this.var_786 = true;
               }
            }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1328 = _loc4_.id;
                     this.var_1669 = _loc4_.breed;
                     break;
                  }
               }
            }
