package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1466:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1466 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_1974 = parseInt(param1.@precedence);
         this.var_1973 = String(param1.@activepartset);
         this.var_1970 = String(param1.@assetpartdefinition);
         this.var_1968 = String(param1.@lay);
         this.var_655 = String(param1.@geometrytype);
         this.var_1967 = Boolean(parseInt(param1.@main));
         this.var_1969 = Boolean(parseInt(param1.@method_6));
         this.var_1971 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_1972 = _loc6_;
            }
            else
            {
               this.var_1466[_loc5_] = _loc6_;
            }
         }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         {
            this.var_639.add(param1,new Map());
         }
         var _loc4_:Map = this.var_639.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_639.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1466[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_1972;
         }
         return _loc2_;
      }
