package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1557:uint = 9;
      ...
      public static const const_296:uint = 3;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_50.updateItemList(this.var_721);
         this.var_50.updateItemList(this.var_1358);
      ...
      public function close() : void
      {
         if(this.var_674)
         {
            if(this._state != const_167 && this._state != const_228)
            {
               this.requestCancelTrading();
               this.state = TradingModel.TRADING_STATE_CANCELLED;
            }
            this.state = const_167;
            this._inventory.toggleInventorySubPage(InventorySubCategory.const_1145);
            this.var_674 = false;
         }
      ...
      {
         this.var_50.setMinimized(param1 != InventoryCategory.const_77);
         this._inventory.updateSubView();
      }
      
      public function set state(param1:uint) : void
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_722 + " OTHER: " + this.var_1104);
         ...
         {
            case const_167:
               if(param1 == const_172 || param1 == const_228)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_50.alertPopup(TradingView.const_1029);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == this.var_721)
            {
               this.var_722 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1104 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_50.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != this.var_721)
            {
               this.var_50.alertPopup(TradingView.const_946);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_290.length < const_1557)
         {
