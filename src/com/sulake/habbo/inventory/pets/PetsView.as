package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      private var var_468:IItemGridWindow;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         this.var_468 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_310);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_540.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_468.removeGridItem(_loc2_.window);
         if(this.var_310 == _loc2_)
         {
            this.var_310 = null;
            this.selectFirst();
         }
      ...
      {
         if(this.var_540 == null || this.var_540.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_540.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_540.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_468.addGridItem(_loc2_.window);
            this.var_540.add(param1.id,_loc2_);
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_310.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_54)
         {
            ...
            {
               case "tab_floor":
                  this.var_62.switchCategory(FurniModel.const_43);
                  break;
               case "tab_wall":
                  this.var_62.switchCategory(FurniModel.const_46);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_310 != null)
         {
            this.var_310.setSelected(false);
         }
         this.var_310 = param1;
         if(this.var_310 != null)
         {
            this.var_310.setSelected(true);
         }
