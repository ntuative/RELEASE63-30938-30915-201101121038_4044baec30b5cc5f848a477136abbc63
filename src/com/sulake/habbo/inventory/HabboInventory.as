package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private var var_1056:IRoomSession;
      ...
      private const const_1879:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_17 != null)
         {
            this.var_17.events.removeEventListener(RoomSessionEvent.const_80,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionEvent.const_87,this.roomSessionEventHandler);
            this.var_17.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_465,this.roomSessionEventHandler);
      ...
      {
         return TradingModel(this.var_46.getValue(InventorySubCategory.const_275));
      }
      
      public function get effectsModel() : EffectsModel
      {
         return EffectsModel(this.var_46.getValue(InventoryCategory.const_706));
      }
      
      public function get badgesModel() : BadgesModel
      {
         return BadgesModel(this.var_46.getValue(InventoryCategory.const_288));
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(this.var_46.getValue(InventoryCategory.const_346));
      }
      ...
      {
         return PetsModel(this.var_46.getValue(InventoryCategory.const_153));
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return this.var_46.getValue(InventoryCategory.const_351) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_80,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionEvent.const_87,this.roomSessionEventHandler);
         this.var_17.events.addEventListener(RoomSessionPropertyUpdateEvent.const_465,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function initInventory() : void
      {
         ...
         this.var_46.add(InventoryCategory.const_351,_loc1_);
         ...
         this.var_46.add(InventoryCategory.const_288,_loc3_);
         ...
         this.var_46.add(InventoryCategory.const_706,_loc4_);
         ...
         this.var_46.add(InventoryCategory.const_346,_loc5_);
         ...
         this.var_46.add(InventorySubCategory.const_275,_loc6_);
         ...
         this.var_46.add(InventoryCategory.const_153,_loc8_);
         this.var_175 = true;
         if(this.var_2213)
         {
            this.requestData();
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_275:
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.method_3(this.const_1879);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_999));
      }
