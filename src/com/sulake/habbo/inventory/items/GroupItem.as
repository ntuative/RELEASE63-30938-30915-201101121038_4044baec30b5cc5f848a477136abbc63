package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_782:int = 0;
      
      protected var var_637:BitmapData;
      
      protected var var_2209:int;
      
      protected var var_1455:Boolean;
      
      protected var var_1949:Boolean;
      
      protected var var_2693:BitmapData;
      
      private const const_1873:int = 8947848;
      
      private const const_1874:int = 13421772;
      
      private const const_1611:Number = 1;
      
      private const const_1612:Number = 0.2;
      ...
      public function initImage() : void
      {
         ...
         {
            _loc1_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1342));
         }
         else
         {
            _loc1_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_1939);
         }
         if(_loc1_.id > 0)
         {
            this.setLoadingImage(_loc1_.data);
            this.var_782 = _loc1_.id;
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_815)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1612;
               _loc1_.blend = this.const_1612;
            }
            else
            {
               this._window.blend = this.const_1611;
               _loc1_.blend = this.const_1611;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_1949 && this.getRecyclableCount() > 0)
            {
