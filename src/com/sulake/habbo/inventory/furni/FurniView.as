package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_897:int = 1;
      
      private const const_1595:int = 2;
      
      private const const_1596:int = 3;
      
      private const const_1607:int = 42;
      
      private const const_1606:int = 120;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         this.var_450.add(FurniModel.const_43,new FurniGridView(this.var_62,FurniModel.const_43,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_450.add(FurniModel.const_46,new FurniGridView(this.var_62,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_450.getValue(this.var_373);
         if(_loc3_)
         {
      ...
      public function setViewToState() : void
      {
         ...
         {
            _loc2_ = this.const_1596;
         }
         if(this.var_2107 == _loc2_)
         {
            return;
         }
         this.var_2107 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_43,FurniModel.const_46];
         var _loc4_:int = 0;
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1606)
         {
            _loc3_ = this.const_1606;
         }
         else if(_loc3_ < this.const_1607)
         {
            _loc3_ = this.const_1607;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_54)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_383);
            }
         }
      }
   }
