package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1179:String = "pixelbalance";
      
      private static const const_1180:String = "badges";
      
      private static const const_1181:String = "selectbadge";
      
      private static const const_1182:String = "inventory";
      ...
      private static const const_1185:String = "pet_inventory";
      ...
      private var var_439:HabboNotificationViewManager;
      
      private var var_197:HabboAlertDialogManager;
      
      private var var_663:ParkBusDialogManager;
      
      private var var_2084:Boolean;
      
      private var var_824:ClubGiftNotification;
      
      private var var_822:ClubEndingNotification;
      
      private var var_821:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_823);
         }
         var _loc6_:Map = this.var_823["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addItem(param1:String, param2:String, param3:BitmapData = null, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_823["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
         ...
         this.var_997.push(_loc8_);
         return this.var_997.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_997.splice(0,1);
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_662.events.addEventListener(HabboToolbarEvent.const_70,this.onHabboToolbarEvent);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_70)
         {
            ...
            this.var_439 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this.var_823["styles"],this.var_823["view"],this.var_662);
            ...
            registerUpdateReceiver(this.var_439,1);
            registerUpdateReceiver(this,2);
            this.var_368.events.addEventListener(BadgeImageReadyEvent.const_135,this.onBadgeImage);
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         this.var_1247[_loc2_.badgeID] = new AchievementNotification(_loc2_.badgeID,_loc2_.achievementID,_loc2_.level,_loc2_.points,_loc2_.levelRewardPoints,_loc2_.levelRewardPointType,_loc2_.bonusPoints,assets,this._windowManager,this._localization,this._config,this._communication,this.var_368);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            this.addItem(_loc4_.value,NotificationType.const_1461);
         }
      }
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_368.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1140);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1140);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1290);
         }
      }
      ...
      public function addOnlineNotification(param1:String, param2:String, param3:String = "") : void
      {
         ...
         var _loc9_:* = null;
         var _loc4_:* = null;
         var _loc7_:IAvatarImage = this.var_512.createAvatarImage(param2,AvatarScaleType.const_48);
         if(_loc7_ != null)
         {
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc9_ = this.var_368.method_4(_loc8_.furniClassId);
               }
         ...
         if(_loc7_)
         {
            this.addItem(_loc7_.value,NotificationType.const_1522,_loc5_);
         }
      ...
      private function getProductImage(param1:String, param2:int, param3:String) : BitmapData
      {
         ...
         switch(param1)
         {
            ...
            case CatalogPageMessageProductData.const_78:
               ...
               break;
            case CatalogPageMessageProductData.const_259:
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1328);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.const_1535)
         {
         ...
         else
         {
            ...
            if(_loc8_ > 0 && _loc2_.daysToPeriodEnd > 0 && _loc2_.daysToPeriodEnd <= _loc8_ && _loc2_.periodsSubscribedAhead == 0)
            {
               ...
               this.var_822 = new ClubEndingNotification(_loc2_.daysToPeriodEnd,_loc2_.isVIP,assets,this._windowManager,this._catalog,this._localization);
            }
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_821 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function onInfoFeedEnable(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1520 = !_loc2_.enabled;
         }
      }
      
      public function update(param1:uint) : void
      {
         if(this.var_439.isSpaceAvailable() && this.var_997.length > 0)
         {
            this.var_439.showItem(this.getNextItemFromQueue());
         }
      }
      ...
      {
         if(param1 != null && this.var_439 != null)
         {
            this.var_439.replaceIcon(param1);
         }
      }
      ...
      private function tempCategoryMapping(param1:String, param2:int) : int
      {
         ...
         if(param1 == "I")
         {
            if(param2 == 3001)
            {
               return FurniCategory.const_372;
            }
            if(param2 == 3002)
            {
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_663 == null)
         {
            this.var_663 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_663 != null)
         {
            this.var_663.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_512.createPetImageFromFigure(_loc2_.figure,AvatarScaleType.const_48);
         if(_loc4_ == null)
         {
            return;
         }
         _loc4_.setDirection(AvatarSetType.const_32,3);
         var _loc5_:BitmapData = _loc4_.getCroppedImage(AvatarSetType.const_44);
         _loc4_.dispose();
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1114,_loc5_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         var _loc4_:IAvatarImage = this.var_512.createPetImageFromFigure(_loc2_.pet.figure,AvatarScaleType.const_48);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2084)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_987);
            this.var_2084 = true;
      ...
      {
         if(param2.type == WindowEvent.const_174 || param2.type == WindowEvent.const_657)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_824 && this.var_824.visible)
         {
            return;
         }
         this.var_824 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_987,_loc6_);
      }
   }
}
