package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1676:Date;
      
      private var _localizationCode:String;
      
      private var var_190:Boolean = false;
      
      private var var_2316:uint = 2;
      
      private var var_2317:uint = 0;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1604 = param1.roomItemTypeName;
         this.var_1606 = param1.rewardCurrencyAmount;
         this.var_1676 = new Date();
         this.var_1676.setTime(param1.endDateTimeStamp);
      ...
      private function updateView() : void
      {
         ...
         {
            case QuestStatusEnum.const_40:
               _loc2_ = ["icon",this.var_69.code,"active"].join("_");
         ...
         var _loc3_:String = ["quest",this.var_69.code,this._localizationCode].join("_");
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_190)
            {
               this.var_817.style = this.var_2317;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_190)
            {
               this.var_817.style = this.var_2316;
            }
         }
      }
