package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      {
         this.var_216 = IFrameWindow(this.var_69.controller.questEngine.getXmlWindow("QuestCompletedDialog"));
         ...
         this.var_216.findChildByName("description").caption = this.var_69.controller.questEngine.localization.getKey(_loc4_ + ".completed.desc");
         this.var_216.findChildByName("reward.currency.desc").caption = this.var_69.controller.questEngine.localization.getKey(_loc3_ + ".completed.currency");
         var _loc5_:String = "icon_" + this.var_69.code + "_reward_" + param1.rewardCurrencyAmount;
