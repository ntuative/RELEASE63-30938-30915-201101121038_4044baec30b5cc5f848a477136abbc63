package com.sulake.habbo.quest
{
   ...
   public class QuestController implements IDisposable
   {
      ...
      private var var_271:QuestCampaign;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_180)
         {
            for each(_loc1_ in this.var_180)
            {
               _loc1_.dispose();
            }
      ...
      {
         var _loc3_:QuestCampaign = this.var_180[param1];
         if(_loc3_)
         {
      ...
      public function openCampaign(param1:String, param2:int, param3:Array) : void
      {
         ...
         this.detachCampaign();
         var _loc4_:QuestCampaign = this.var_180[param1];
         if(!_loc4_)
         {
            _loc4_ = new QuestCampaign(this,param1);
            this.var_180[param1] = _loc4_;
         }
         else
         {
         ...
         this.var_271 = _loc4_;
         this.var_271.openCampaign(param3);
         this.prepareWindow();
         this.attachCampaign();
      }
      ...
      private function attachCampaign() : void
      {
         ...
         this.var_1000.addChild(this.var_271.window);
         var _loc1_:String = "quest_" + this.var_271.code;
      ...
      public function openCampaigns(param1:Array, param2:Boolean = false) : void
      {
         ...
         {
            _loc5_ = this.var_180[_loc3_];
            if(!_loc5_)
            {
               _loc5_ = new QuestCampaign(this,_loc3_);
               this.var_180[_loc3_] = _loc5_;
            }
         ...
         if(this.var_271)
         {
            _loc4_ = this.var_271.code;
         }
         else if(this.var_180.getKeys().length > 0)
         {
            _loc4_ = this.var_180.getKeys()[0];
         }
         if(_loc4_ != "")
         {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1000 = this._window.findChildByName("content") as IWindowContainer;
      }
      ...
      private function refreshTabs() : void
      {
         ...
         for each(_loc4_ in this.var_180.getKeys())
         {
            _loc3_ = this.var_180[_loc4_];
            _loc2_ = _loc1_.getTabItemByName("tab_" + _loc4_);
            if(!_loc2_)
            {
               _loc2_ = this.var_157.windowManager.createWindow("tab_" + _loc4_,_loc4_,WindowType.const_540) as ITabButtonWindow;
               _loc1_.addTabItem(_loc2_);
               _loc2_.addEventListener(WindowEvent.const_54,this.onTabSelect);
            }
            _loc5_ = 4287150640;
            if(!_loc3_.expired)
            {
