package com.sulake.habbo.quest
{
   ...
   public class QuestView implements IGetImageListener, IDisposable
   {
      ...
      private var var_109:Quest;
      
      private var _view:IWindow;
      
      private var var_1726:int;
      
      private var var_2428:IScrollableListWindow;
      ...
      private function createView() : void
      {
         switch(this.var_109.type)
         {
            ...
            case QuestTypeEnum.FIND_HIDDEN_STUFF:
               ...
               this.var_2428 = this.find("quest.content.itemlist") as IScrollableListWindow;
               if(!this._view)
               {
                  throw new Error("[QuestView] Could not create view for quest type: " + this.var_109.type + " !");
               }
               return;
               break;
            default:
               throw new Error("[QuestView] View not defined for quest type: " + this.var_109.type + " !");
         }
      }
      ...
      public function onActivateQuest(param1:Event, param2:IWindow = null) : void
      {
         if(this.var_109)
         {
            this.var_69.controller.activateQuest(this.var_109);
         }
      }
      ...
      private function localize() : void
      {
         ...
         var _loc33_:* = null;
         var _loc34_:* = null;
         var _loc1_:String = ["quest",this.var_69.code,this.var_109.localizationCode].join("_");
         var _loc2_:String = ["quest_" + this.var_69.code,"type_" + this.var_109.type.toLowerCase()].join(".");
         var _loc3_:String = "quest_" + this.var_69.code;
         ...
         if(this.var_109.type == QuestTypeEnum.FIND_STUFF)
         {
            _loc32_ = this.var_69.controller.questEngine.sessionDataManager.getFloorItemDataByName(this.var_109.roomItemTypeName);
            if(_loc32_)
            {
               _loc33_ = this.var_69.controller.questEngine.roomEngine.getFurnitureImage(_loc32_.id,new Vector3d(90,0,0),64,this,"");
               this.var_1726 = _loc33_.id;
         ...
         else if(this.var_109.type == QuestTypeEnum.FIND_HIDDEN_STUFF)
         {
         ...
         switch(this.var_109.status)
         {
            case QuestStatusEnum.const_466:
            ...
            case QuestStatusEnum.const_182:
               ...
               _loc18_ = 4290822336;
               break;
            case QuestStatusEnum.const_595:
         ...
         this.var_69.controller.questEngine.localization.registerParameter(_loc14_,"amount",this.var_109.rewardCurrencyAmount.toString());
         this.setText("quest.reward.title",_loc13_);
         this.setText("quest.reward.desc",_loc14_);
         var _loc19_:int = this.var_109.endDate.date;
         var _loc20_:int = this.var_109.endDate.month + 1;
         var _loc21_:int = this.var_109.endDate.fullYear;
         var _loc22_:int = this.var_109.endDate.minutes;
         var _loc23_:int = this.var_109.endDate.hours;
         ...
         var _loc29_:String = "header_" + this.var_69.code;
         ...
         var _loc31_:String = "icon_" + this.var_69.code + "_reward_" + this.var_109.rewardCurrencyAmount;
