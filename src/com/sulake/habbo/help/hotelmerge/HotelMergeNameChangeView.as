package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_730)
         {
            this.var_730 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_730)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_729)
         {
            this.var_729 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_729)
            {
               return;
            }
