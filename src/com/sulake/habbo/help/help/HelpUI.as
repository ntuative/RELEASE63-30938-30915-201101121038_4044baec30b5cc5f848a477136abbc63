package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1622:int = 0;
      
      private static const const_1621:int = 0;
      ...
      {
         this.var_336 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201101120946));
         this._toolbar = param5;
         this.var_97 = new Map();
         this.var_97.add(HabboHelpViewEnum.const_1492,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_166,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_550,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_287,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_225,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_637,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_342,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_816,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_210,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_97.add(HabboHelpViewEnum.const_1034,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_97.add(HabboHelpViewEnum.const_1032,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_97.add(HabboHelpViewEnum.const_587,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_482.length == 0 || param1 != this.var_336)
            {
               this.var_482.push(this.var_336);
            }
         }
         this.var_336 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_336);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_210:
               ...
               break;
            case CallForHelpResultEnum.const_1141:
               this.showUI(HabboHelpViewEnum.const_1032);
               break;
            case CallForHelpResultEnum.const_1151:
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_97.getValue(HabboHelpViewEnum.const_166) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_437));
      }
      ...
      {
         return this.var_97.getValue(this.var_336);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1772 = this._window.width - _loc4_.width;
         this.var_1771 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1771;
         this._window.width = _loc1_.width + this.var_1772;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_482.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_336 == HabboHelpViewEnum.const_166)
         {
            return;
         }
         if(this.var_599.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_599.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_599.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_337.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_599[1],this.var_599[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_599[0],this.var_599[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_336 == HabboHelpViewEnum.const_166 || this.var_482.length == 0)
         {
            return;
         }
         if(this.var_337 == null)
         {
            ...
            this.var_337 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_337.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_337.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_337 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_337 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_337 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
