package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_320:String = "TUI_NAME_VIEW";
      
      public static const const_380:String = "TUI_CLOTHES_VIEW";
      
      public static const const_493:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_348:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         ...
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_529,this.onTaskDoneEvent);
         this.var_33.events.addEventListener(HabboHelpTutorialEvent.const_470,this.onTaskDoneEvent);
         if(this.var_33.sessionDataManager != null)
         {
            this.var_33.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_304,this.onFigureUpdate);
         }
      }
      ...
      {
         return this.var_1165 && this.var_1166 && this.var_1423;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_33)
         {
            ...
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_529,this.onTaskDoneEvent);
            this.var_33.events.removeEventListener(HabboHelpTutorialEvent.const_470,this.onTaskDoneEvent);
            if(this.var_33.sessionDataManager != null)
            {
               this.var_33.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_304,this.onFigureUpdate);
            }
            this.var_33 = null;
         }
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         if(this.var_39 == null || this.var_39.id == const_84)
         {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_437:
               this.var_1423 = true;
               if(this.var_39 != null && this.var_39.id == const_493)
               {
                  this.showView(const_84);
               }
               break;
            case HabboHelpTutorialEvent.const_529:
               if(this.var_39 != null && this.var_39.id == const_380)
               {
                  this.var_1855 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_1772 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_320:
               ...
               if(this.var_348 == null)
               {
                  this.var_348 = new NameChangeView(this);
               }
               this.var_348.showMainView();
               this.prepareForTutorial();
               break;
            case const_380:
         ...
         this._window.height = _loc2_.height + this.var_1771;
         this._window.width = _loc2_.width + this.var_1772;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_39 != null && (this.var_39.id == const_320 || this.var_39.id == const_84))
         {
            this.showView(const_84);
         }
      }
      ...
      {
         this.var_1165 = true;
         if(this.var_39 != null && (this.var_39.id == const_380 || this.var_39.id == const_84))
         {
            this.showView(const_84);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_514)
         {
            this.var_1166 = true;
         ...
         {
            this.var_348.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_514)
         {
            this.var_348.checkedName = _loc2_.name;
         }
         else
         {
            this.var_348.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
