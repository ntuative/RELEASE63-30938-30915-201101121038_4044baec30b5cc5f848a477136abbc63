package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1375:uint = 13232628;
      ...
      private var var_1129:NameSuggestionListRenderer;
      ...
      private function showView(param1:IWindowContainer) : void
      {
         ...
         if(this._window)
         {
            this._window.content.width = this.var_39.width;
            this._window.content.height = this.var_39.height;
         }
      }
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1760 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_730)
         {
            this.var_730 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_730)
            {
               return;
            }
            this._window.content.addChild(this.var_730);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_729)
         {
            this.var_729 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_729)
            {
               return;
            }
            this._window.content.addChild(this.var_729);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_729.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_480;
         }
         this.showView(this.var_729);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_480);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_771:
               ...
               break;
            case ChangeUserNameResultMessageEvent.var_772:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_955 || param1 == ChangeUserNameResultMessageEvent.var_954)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1129 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1129.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1375;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_480 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_480);
               break;
