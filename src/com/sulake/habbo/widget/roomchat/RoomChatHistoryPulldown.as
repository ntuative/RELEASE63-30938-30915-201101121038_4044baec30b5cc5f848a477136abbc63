package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private var var_2557:BitmapData;
      
      private var var_2554:BitmapData;
      
      private var var_2556:int = 30;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_36 = param3;
         this.var_2559 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1806 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2558 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1805 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1807 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2557 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2554 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_70 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_309,HabboWindowStyle.const_30,HabboWindowParam.const_58,new Rectangle(0,0,param3.width,param3.height - const_76),null,0,0) as IBitmapWrapperWindow;
         this.var_36.addChild(this.var_70);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_55,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_36.height - const_76,param3.width,const_76),null,0) as IWindowContainer;
         this.var_36.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_758,HabboWindowStyle.const_37,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_76),null,0) as IRegionWindow;
         if(this._region != null)
         {
            ...
            this.var_36.addChild(this._region);
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_428:
               this.var_70.blend += param1 / const_904;
               ...
               break;
            case const_911:
               this.var_70.blend -= param1 / const_903;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            this._window.x = 0;
            this._window.y = this.var_36.height - const_76;
            this._window.width = this.var_36.width;
         }
         if(this._region != null)
         {
            this._region.x = 0;
            this._region.y = this.var_36.height - const_76;
            this._region.width = this.var_36.width - this.var_2556;
         }
         if(this.var_70 != null)
         {
            this.var_70.rectangle = this.var_36.rectangle;
            this.var_70.height -= const_76;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2555 == this._window.width)
         {
            return;
         }
         this.var_2555 = this._window.width;
         ...
         {
            _loc5_.bitmap = this.var_2558;
            _loc5_.disposesBitmap = false;
            _loc2_.bitmap = this.var_1805;
            _loc2_.disposesBitmap = false;
            this.var_2556 = this._window.width - _loc2_.x;
         }
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_2559,_loc7_);
            ...
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1806,_loc8_);
            ...
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               ...
               this.tileBitmapHorz(this.var_1806,_loc9_);
         ...
         this.var_70.bitmap = this.var_2554;
