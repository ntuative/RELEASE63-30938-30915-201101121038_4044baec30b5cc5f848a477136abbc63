package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private var var_918:IWindow;
      
      private var var_434:Number;
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_918 != null)
         {
            if(this.var_170.isActive)
            {
               ...
               this.var_918.width = _loc2_ * this.var_434;
            }
            else
            {
               this.var_918.width = 0;
               this.var_179.stop();
            }
            this.setTimeLeft();
         }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_919.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = this.var_919.text;
            if(this.var_170.isActive)
            {
               ...
               this.var_919.text = _loc1_;
            }
            else
            {
               this.var_919.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            this.var_920 = this._window.findChildByName("effect_hilite");
            this.var_920.visible = false;
         }
         this.var_919 = this._window.findChildByName("time_left") as ITextWindow;
         this.setTimeLeft();
         this.var_918 = this._window.findChildByName("loader_bar");
         if(this.var_918 != null)
         {
            this.var_434 = this.var_918.width;
            this.var_179.start();
            this.onUpdate();
         }
