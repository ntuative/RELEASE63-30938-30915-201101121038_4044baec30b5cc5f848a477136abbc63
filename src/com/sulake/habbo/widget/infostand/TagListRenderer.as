package com.sulake.habbo.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private const const_1872:int = 5;
      
      private const const_1871:int = 5;
      
      private var _widget:InfostandWidget;
      
      private var var_142:Function;
      
      private var _offsetX:int;
      
      private var var_981:int;
      
      private var var_982:Rectangle = null;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_981 = 0;
         this.var_982 = param2.rectangle.clone();
         this.var_982.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_982.width)
         {
            return false;
         }
         if(this.var_981 + param1.height > this.var_982.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_982.width)
         {
            this._offsetX = 0;
            this.var_981 += param1.height + this.const_1871;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_981);
         this._offsetX += param1.width + this.const_1872;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1229 != null && this.var_1229.indexOf(param1) != -1)
         {
         ...
         _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.var_142);
