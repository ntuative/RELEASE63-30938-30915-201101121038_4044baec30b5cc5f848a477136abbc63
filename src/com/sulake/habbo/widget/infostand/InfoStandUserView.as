package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1171:TagListRenderer;
      
      private var var_126:IBorderWindow;
      
      private var var_2513:int;
      
      private const const_896:int = 5;
      
      private const const_1628:int = 39;
      
      private const const_1627:int = 7829367;
      
      private const const_1626:int = 16777215;
      
      private const const_1909:int = 2000;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1171 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_213.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = this.var_213.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = this.var_213.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = this.var_213.findChildByName("badge_group");
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_896;
      ...
      {
         var _loc3_:ITextWindow = this.var_49.getListItemByName("motto_text") as ITextWindow;
         var _loc4_:IWindowContainer = this.var_49.getListItemByName("motto_spacer") as IWindowContainer;
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1627;
            }
            else
            {
               _loc3_.textColor = this.const_1626;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = _loc3_.textHeight + this.const_896;
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_377,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_377,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1171.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1066:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1148:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2513 > this.const_1909 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2513 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1627;
            if(_loc3_.length >= this.const_1628)
            {
               _loc2_.text = _loc3_.substring(0,this.const_1628 - 1);
            }
         }
      }
