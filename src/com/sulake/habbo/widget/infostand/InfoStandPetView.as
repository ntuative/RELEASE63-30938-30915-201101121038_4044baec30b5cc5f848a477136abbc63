package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1895:int = 158;
      
      private const const_1892:int = 16;
      
      private const const_1898:uint = 11184810;
      
      private const const_1896:uint = 6710886;
      
      private const const_1893:uint = 3355443;
      
      private const const_1897:String = "level";
      
      private const const_1894:String = "experience";
      
      private const const_1900:String = "energy";
      
      private const const_1899:String = "nutrition";
      ...
      {
         if(this.var_49 == null || this.var_213 == null || this.var_63 == null)
         {
            return;
         }
         ...
         this.var_213.height = this.var_49.height + 20;
         this._window.width = Math.max(this.var_213.width,this.var_63.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_213.width < this.var_63.width)
         {
            this.var_213.x = this._window.width - this.var_213.width;
            this.var_63.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1897,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1894,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1900,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1899,param1.nutrition,param1.nutritionMax);
         ...
         this.updateWindow();
         this.var_504 = param1.id;
         this.var_1365.remove(param1.id);
         this.var_1365.add(param1.id,param1);
         if(this.var_184 && this.var_184.isVisible() && param1.isOwnPet)
         {
            this.var_184.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_184.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1895,this.const_1892,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1898);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1893);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1896);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         if(this.var_184 == null)
         {
            this.var_184 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this.var_1365.getValue(this.var_504) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_184.showWindow(true);
            this.var_184.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_213 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_213 != null)
         {
            this.var_49 = this.var_213.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         this._widget.mainContainer.addChild(this._window);
         var _loc3_:IWindow = this.var_213.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_213.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_184 && this.var_184.getPetId() == this.var_504)
               {
                  this.var_184.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_483,this._widget.petData.ownerId);
