package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_427.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_427 = null;
         }
         if(this.var_42 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_270,this.onHideLoadingBar);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_270,this.onHideLoadingBar);
      }
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         this.var_1209 = param1.clickUrl;
         var _loc2_:IDisplayObjectWrapper = this._window.findChildByName("image") as IDisplayObjectWrapper;
         if(_loc2_ == null)
         {
            return;
         }
         var _loc3_:int = Math.max(0,this.var_42.width - _loc2_.width);
         var _loc4_:int = Math.max(0,this.var_42.height - _loc2_.height);
         this._window.scale(_loc3_,_loc4_);
         if(this.var_427 == null)
         {
            this.var_427 = new Sprite();
            this.var_427.addChild(new Bitmap(this.var_42));
            this.var_427.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_427.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_42;
            }
         }
         _loc2_.setDisplayObject(this.var_427);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_270)
         {
            return;
         }
         if(this._window != null)
      ...
      private function clickHandler(param1:Event) : void
      {
         if(this.var_1209 != "")
         {
            HabboWebTools.openWebPage(this.var_1209);
         }
      }
   }
}
