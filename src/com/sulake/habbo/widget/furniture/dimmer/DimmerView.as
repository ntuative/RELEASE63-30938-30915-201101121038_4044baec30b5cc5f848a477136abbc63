package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_55,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1170,const_1171,2,2),null,0) as IWindowContainer;
         ...
         this.var_236 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_236.numTabItems)
         {
            _loc6_ = this.var_236.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1380 = _loc2_.light;
         if(this.var_399 != null)
         {
            this.var_399.setValue(this.var_1380);
         }
         this.var_485 = this.colors.indexOf(_loc2_.color);
         if(this.var_598 != null)
         {
            this.var_598.setSelectedColorIndex(this.var_485);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_236.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_236.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_236.selector.getSelected();
         return this.var_236.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1379 = XML(_loc1_.content);
         return this.var_1379;
      }
