package com.sulake.habbo.widget.poll
{
   ...
   public class PollSession implements IDisposable
   {
      ...
      private var var_1016:PollWidget;
      ...
      {
         this.hideOffer();
         this.var_231 = new PollOfferDialog(this._id,param1,this.var_1016);
      }
      ...
      public function showContent(param1:String, param2:String, param3:Array) : void
      {
         ...
         this.var_231 = new PollContentDialog(this._id,param1,param3,this.var_1016);
      }
      ...
      {
         this.var_1016.windowManager.alert("${poll_thanks_title}",this.var_1580,0,function(param1:IAlertDialog, param2:Event):void
         {
            param1.dispose();
         });
      }
