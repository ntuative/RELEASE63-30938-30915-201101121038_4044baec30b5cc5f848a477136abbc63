package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1244:Array = null;
      
      private var var_1025:Array = null;
      
      private var var_1889:int = -1;
      
      private var var_1445:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1445 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      private function updateTimer(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc4_ = Number(param1) / this.var_1445;
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1445 - param1) / 1000,0);
      ...
      private function update(param1:RoomWidgetFrameUpdateEvent) : void
      {
         ...
         var _loc2_:int = getTimer() - this.var_2469;
         if(_loc2_ > this.var_1445)
         {
            this.vote();
            return;
         }
