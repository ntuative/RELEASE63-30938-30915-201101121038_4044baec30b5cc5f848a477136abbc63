package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_521:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_148.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_140,HabboWindowStyle.const_37,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1624,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1624,"/");
         ...
         {
            dispatchEvent(new Event(const_521));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_125.removeEventListener(SSOTicket.const_382,this.onParsedTicketSuccess);
            this.var_125.removeEventListener(SSOTicket.const_262,this.onParsedTicketFailure);
            this.var_125 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_125 = new SSOTicket(this.var_148.assets,_loc3_,_loc2_,param1);
         this.var_125.addEventListener(SSOTicket.const_382,this.onParsedTicketSuccess);
         this.var_125.addEventListener(SSOTicket.const_262,this.onParsedTicketFailure);
      }
      
      private function onParsedTicketSuccess(param1:Event) : void
      {
         Logger.log("Got ticket: " + this.var_125.ticket);
         Logger.log("Has Facebook: " + this.var_125.isFacebookUser);
         if(this.var_125.isFacebookUser)
         {
            this.var_148.habboConfiguration.setKey("facebook.user","1");
         }
         this.var_148.shockwaveClientUrl = this.var_125.shockwaveClientUrl;
         this.var_148.ssoTicket = this.var_125.ticket;
         this.var_125.removeEventListener(SSOTicket.const_382,this.onParsedTicketSuccess);
         this.var_125.removeEventListener(SSOTicket.const_262,this.onParsedTicketFailure);
         this.var_125 = null;
         dispatchEvent(new Event(const_521));
