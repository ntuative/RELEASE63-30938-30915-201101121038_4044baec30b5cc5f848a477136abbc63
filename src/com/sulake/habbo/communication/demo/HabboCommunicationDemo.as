package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_487:IKeyExchange;
      
      private var var_921:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2518:PseudoRandom;
      ...
      private const const_1624:String = "fuselogin";
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_605 = param1;
            this.var_48.initConnection(HabboConnectionType.const_211);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_17.events.addEventListener(RoomSessionEvent.const_87,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      {
         if(this.var_48 && this._habboConfiguration && this.var_17 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_605 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1790 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_2516 = this._habboConfiguration.getKey("external.variables.txt","");
         if(this.var_214 == null)
         {
            this.var_214 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         if(_loc3_)
         {
            this.var_48.mode = HabboConnectionType.const_112;
            if(this.var_605)
            {
               this.var_48.initConnection(HabboConnectionType.const_211);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_521,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_48.mode = HabboConnectionType.const_973;
            }
         }
         this.var_48.initConnection(HabboConnectionType.const_211);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_689);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2518 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_48.mode)
         {
            case HabboConnectionType.const_112:
               ...
               this.var_1401 = _loc4_;
               this.var_214.loadBannerImage(_loc7_ + "?token=" + this.var_1401,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_973:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1523:
               this.var_921 = this.generateRandomHexString(30);
               this.var_487 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_487.init(this.var_921);
               _loc8_ = this.var_487.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_487.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_487.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2518);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1400 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_232);
         connection.send(new VersionCheckMessageComposer(401,this.var_1790,this.var_2516));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1624,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_605 != null)
         {
            ...
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_185);
         }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_257);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1400)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_176);
         }
         if(param1.type == Event.CLOSE && !this.var_2517)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1401);
         ...
         this.var_487 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_487.init(_loc14_);
            _loc15_ = this.var_487.getPublicKey(10);
