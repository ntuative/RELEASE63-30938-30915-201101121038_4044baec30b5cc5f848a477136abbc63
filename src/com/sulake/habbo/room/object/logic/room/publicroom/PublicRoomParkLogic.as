package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1189:String = "goawaybus";
      
      private static const const_1187:String = "bus";
      
      private static const const_1188:String = "bus_oviopen_hidden";
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               switch(_loc3_.spriteTag)
               {
                  ...
                  case const_1187:
                  case const_1188:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_411,0,_loc4_,_loc5_);
               }
         }
