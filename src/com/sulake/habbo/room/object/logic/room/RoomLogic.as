package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1737:int = 255;
      
      private var var_1421:uint = 16777215;
      
      private var var_1847:int = 255;
      
      private var var_1163:uint = 16777215;
      
      private var var_1849:int = 255;
      
      private var var_1162:int = 0;
      
      private var var_1848:int = 1500;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1105,param1.toString(),true);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1162)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1737;
            if(_loc2_ - this.var_1162 >= this.var_1848)
            {
               _loc3_ = this.var_1163;
               _loc4_ = this.var_1849;
               this.var_1162 = 0;
            }
            else
            {
               _loc7_ = this.var_1421 >> 16 & 255;
               _loc8_ = this.var_1421 >> 8 & 255;
               _loc9_ = this.var_1421 & 255;
               _loc10_ = this.var_1163 >> 16 & 255;
               _loc11_ = this.var_1163 >> 8 & 255;
               _loc12_ = this.var_1163 & 255;
               _loc13_ = (_loc2_ - this.var_1162) / this.var_1848;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1847 + (this.var_1849 - this.var_1847) * _loc13_;
               this._color = _loc3_;
               this.var_1737 = _loc4_;
            }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_600:
               param2.setString(RoomObjectVariableEnum.const_621,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_612:
               param2.setString(RoomObjectVariableEnum.const_638,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_728:
               param2.setString(RoomObjectVariableEnum.const_658,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_425:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_245)
               {
                  _loc5_ = "null";
               }
               this.var_509.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_828:
               _loc4_ = this.var_509.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_509.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1044,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1113:
               ...
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1060:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1115,int(param1.bgOnly));
         this.var_1421 = this._color;
         this.var_1847 = this.var_1737;
         this.var_1163 = _loc3_;
         this.var_1849 = _loc4_;
         this.var_1162 = getTimer();
         this.var_1848 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_438,0);
            }
            return;
         }
         _loc5_--;
         ...
         var _loc16_:Number = _loc3_.method_14;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1504,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1287,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1550,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_438,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_163)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_158 || _loc13_ == RoomPlaneData.const_282)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
