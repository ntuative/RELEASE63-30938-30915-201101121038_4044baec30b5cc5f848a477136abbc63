package com.sulake.habbo.room.object.logic
{
   ...
   public class MovingObjectLogic extends ObjectLogicBase
   {
      ...
      public static const const_715:int = 500;
       
      
      private var var_1425:Vector3d;
      
      private var var_2766:Vector3d;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(object != null)
         {
            if(param1.loc != null)
            {
               ...
               this.var_2639 = this._lastUpdateTime;
               this.var_1425 = _loc4_;
            }
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         {
            _loc2_ = param1 - this.var_2639;
            if(_loc2_ > this.var_1067)
            {
               _loc2_ = this.var_1067;
            }
            _loc3_ = Vector3d.product(this.var_1425,_loc2_ / Number(this.var_1067));
