package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1836:int = 1;
      
      public static const const_1759:int = 16777216;
      ...
      private var var_1826:int = 16777216;
      
      private var var_2732:int = 69069;
      
      private var var_2733:int = 5;
      ...
      {
         var _loc1_:int = this.var_2732 * this.var_1825 + this.var_2733;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1826;
         this.var_1825 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1826 * param2);
      }
   }
}
