package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_396:int = 2;
      
      private static const const_868:int = 15;
      
      private static const const_867:int = 31;
      
      private static const const_1178:int = 2;
      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(_loc2_ != null)
         {
            this.var_660[0] = this.getNewPoint(param1,0);
         }
         _loc2_ = method_1(3);
         if(_loc2_ != null)
         {
            this.var_660[1] = this.getNewPoint(param1,1);
         }
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            ...
            {
               return this.var_660[param3 - 2].x;
            }
         }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         if(param3 == 2 || param3 == 3)
         {
            if(this.var_660.length == 2)
            {
               return this.var_660[param3 - 2].y;
            }
         }
      ...
      {
         var _loc7_:int = 0;
         var _loc3_:Number = this.var_995[param2];
         var _loc4_:int = this.var_996[param2];
         var _loc5_:int = this.var_994[param2];
         var _loc6_:Number = this.var_993[param2];
         if(param1 == 32)
         {
            _loc7_ = const_868;
         }
         ...
         this.var_995[param2] = _loc3_;
         if(int(_loc9_) == 0)
         {
            this.var_993[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_994.push(const_1178);
         this.var_994.push(ANIM_SPEED_SLOW);
         this.var_993 = new Array();
         this.var_993.push(this.getRandomAmplitudeFactor());
         this.var_993.push(this.getRandomAmplitudeFactor());
      }
