package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1244:String = "shore";
       
      
      private var var_1799:Boolean = true;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1148)
            {
      ...
      {
         if(this.var_2538 == param1 && this.var_2537 == _direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,_direction,_loc2_) == const_1244)
            {
               this.var_1797 = _loc2_;
               this.var_2538 = param1;
               this.var_2537 = _direction;
               return this.var_1797;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1148.indexOf(_loc2_) < 0)
            {
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_492 + 2;
         var _loc4_:int = this.var_611 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1799 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_403.length)
         {
            if(this.var_403[_loc5_] == true)
            {
               this.var_1799 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_610[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_610[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_492 == 0 || this.var_611 == 0)
         {
            ...
            this.var_492 = _loc2_.getNumber(RoomObjectVariableEnum.const_263);
            this.var_611 = _loc2_.getNumber(RoomObjectVariableEnum.const_344);
         }
         this.var_403 = [];
         this.var_610 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_492 * 2 + this.var_611 * 2)
         {
            this.var_403.push(false);
            this.var_610.push(ShoreMaskCreatorUtility.const_71);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_492 + 2;
         var _loc2_:int = this.var_611 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      {
         if(this.var_66 == null || this.var_66.width < param1 || this.var_66.height < param2)
         {
            if(this.var_66 != null)
            {
               this.var_66.dispose();
            }
            this.var_66 = ShoreMaskCreatorUtility.createEmptyMask(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_66,getSize(param3),this.var_403,this.var_610,assetCollection);
      }
