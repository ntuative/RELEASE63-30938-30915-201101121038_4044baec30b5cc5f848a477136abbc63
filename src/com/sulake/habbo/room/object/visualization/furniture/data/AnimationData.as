   ...
   public class AnimationData
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_104 != null)
         {
            ...
            {
               _loc2_ = this.var_104.getWithIndex(_loc1_) as AnimationLayerData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      public function getStartFrame(param1:int) : int
      {
         ...
         return Math.random() * this.var_378;
      }
      ...
      private function addLayer(param1:int, param2:int, param3:int, param4:Boolean, param5:XML) : Boolean
      {
         ...
         this.var_104.add(param1,_loc6_);
         var _loc11_:int = _loc6_.frameCount;
         if(_loc11_ > this.var_378)
         {
            this.var_378 = _loc11_;
         }
         return true;
      }
      ...
      {
         var _loc4_:AnimationLayerData = this.var_104.getValue(param2) as AnimationLayerData;
         if(_loc4_ != null)
         {
      ...
      {
         var _loc6_:AnimationLayerData = this.var_104.getValue(param2) as AnimationLayerData;
         if(_loc6_ != null)
         {
