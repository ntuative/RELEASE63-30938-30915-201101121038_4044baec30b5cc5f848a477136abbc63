package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1584:Number = Math.sqrt(0.5);
       
      
      protected var _direction:int;
      
      protected var var_2699:Number = NaN;
      
      protected var var_2700:int = -1;
      
      protected var _alphaMultiplier:Number = 1.0;
      
      protected var var_1209:String = null;
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:Array) : void
      {
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         if(this.var_1865 != spriteCount)
         {
            createSprites(this.var_1865);
         }
         var _loc4_:Boolean = false;
      ...
      private function updateSprite(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         var _loc5_:IRoomObjectSprite = method_1(param2);
         if(_loc5_ != null)
         {
            _loc6_ = null;
            ...
            if(_loc6_ != null && _loc6_.asset != null)
            {
               ...
               if(param2 < spriteCount - 1)
               {
                  ...
                  _loc5_.color = this.getSpriteColor(param1,param2,this.var_2700);
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_1003:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1128:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_425 != _loc3_.getUpdateID() || param1 != var_221 || param2 != this.var_2699)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2700 = _loc3_.getNumber(RoomObjectVariableEnum.const_227);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_294));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1209 = _loc3_.getString(RoomObjectVariableEnum.const_356);
            if(this.var_1209 == null || this.var_1209.indexOf("http") != 0)
            {
               this.var_1209 = null;
            }
      ...
      {
         if(this.var_2647 != param2 || this.var_2646 != param1)
         {
            this.var_942 = [];
            this.var_941 = [];
            this.var_760 = [];
            ...
            this.var_1865 = this._data.getLayerCount(param1) + 1;
         }
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_1152.length)
         {
            return "";
         }
         var _loc3_:String = this.var_942[param2];
         var _loc4_:Boolean = this.var_941[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            ...
            if(param2 < spriteCount - 1)
            {
               _loc6_ = FurnitureVisualizationData.const_1152[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_942[param2] = _loc3_;
            this.var_941[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_760[param3] != null)
         {
            return this.var_760[param3];
         }
         if(this._data == null)
         {
            return "";
         ...
         this.var_760[param3] = _loc4_;
         return _loc4_;
      }
      
      protected function getSpriteAlpha(param1:int, param2:int, param3:int) : int
      {
         if(this.var_761[param3] != null && !this.var_1866)
         {
      ...
      {
         if(this.var_759[param2] != null)
         {
            return this.var_759[param2];
         }
         if(this._data == null)
         {
      ...
      {
         if(this.var_758[param3] != null)
         {
            return this.var_758[param3];
         }
         if(this._data == null)
         {
