package com.sulake.habbo.navigator
{
   ...
   public class Util
   {
      ...
      private static var var_1215:CutToWidth = new CutToWidth();
      
      private static var var_1216:CutToHeight = new CutToHeight();
      ...
      public static function cutTextToWidth(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1215.beforeSearch(param2,param1,param3);
         binarySearch(var_1215,param2.length - 1);
      }
      ...
      public static function cutTextToHeight(param1:ITextWindow, param2:String, param3:int) : void
      {
         ...
         var_1216.beforeSearch(param2,param1,param3);
         binarySearch(var_1216,param2.length - 1);
      }
