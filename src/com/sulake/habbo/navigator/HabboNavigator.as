package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_274:MainViewCtrl;
      
      private var var_547:RoomInfoViewCtrl;
      
      private var var_1019:RoomCreateViewCtrl;
      ...
      private var var_2752:Dictionary;
      ...
      private var var_903:GuestRoomPasswordInput;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_274 = new MainViewCtrl(this);
         this.var_547 = new RoomInfoViewCtrl(this);
         this.var_1019 = new RoomCreateViewCtrl(this);
         this.var_2139 = new RoomThumbnailRenderer(this);
         this.var_903 = new GuestRoomPasswordInput(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_309,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_547.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_107,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_166.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      {
         var _loc1_:Boolean = this.var_274.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_274.startSearch(Tabs.const_256,Tabs.const_387,param1);
         this.var_274.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_274.startSearch(Tabs.const_289,Tabs.const_233);
         this.var_409.getTab(Tabs.const_289).tabPageDecorator.tabSelected();
      }
