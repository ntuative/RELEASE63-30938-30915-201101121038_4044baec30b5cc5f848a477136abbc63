package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_51 == null)
         {
            this.var_51 = IWindowContainer(this._navigator.getXmlWindow(this.var_963));
            this.var_51.visible = false;
            this.var_51.setParamFlag(HabboWindowParam.const_34,true);
         ...
         this.var_51.x = _loc2_.x + this.var_2481 + param1.width;
