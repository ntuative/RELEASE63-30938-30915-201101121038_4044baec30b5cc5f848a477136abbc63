package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_68.addEventListener(WindowKeyboardEvent.const_155,this.checkEnterPress);
         this.var_68.addEventListener(WindowEvent.const_106,this.checkMaxLen);
         this.var_2407 = this.var_68.textBackground;
         this._orgTextBackgroundColor = this.var_68.textBackgroundColor;
         this.var_2405 = this.var_68.textColor;
      }
      ...
      {
         this.var_68.textBackground = this.var_2407;
         this.var_68.textBackgroundColor = this._orgTextBackgroundColor;
         this.var_68.textColor = this.var_2405;
      }
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_68.text = this.var_1298;
            this.var_589 = true;
         }
         else
         {
      ...
      {
         return !this.var_589 && Util.trim(this.getText()).length > 2;
      }
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_68.text = this.var_2406;
         this.var_589 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:Event) : void
      {
         ...
         if(_loc2_.length > this.var_1716)
         {
            this.var_68.text = _loc2_.substring(0,this.var_1716);
         }
      }
   }
}
