package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1021:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_548 = new Timer(100);
         this.var_548.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_40 = new Array();
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,104,"a"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,94,"b"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,36,"c"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,84,"d"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"e"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,80,"f"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,416,"i"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,320,"j"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,448,"k"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,352,"l"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,384,"m"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_49,372,"n"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,80,"g"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,74,"h"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,416,"o"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,352,"p"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,304,"q"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,336,"r"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,748,"u"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_59,438,"v"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,540,"t"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,512,"w"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,396,"x"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,440,"y"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,456,"z"));
         this.var_40.push(new RoomLayout(HabboClubLevelEnum.const_50,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_548)
         {
            this.var_548.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_548.reset();
            this.var_548 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1021.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1571 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1571 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_55 = IItemListWindow(this.var_162.findChildByName("item_list"));
         ...
         this.var_1022 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_162.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      public function refresh() : void
      {
         ...
         this.var_1022.input.textBackgroundColor = 4294967295;
         this.var_1021 = this.var_40[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < this.var_40.length)
         {
            _loc7_ = this.var_40[_loc4_];
            if(this.isAllowed(_loc7_))
            {
               ...
               this.addThumbnail(_loc3_,this.var_40[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_55,HabboWindowStyle.const_30,HabboWindowParam.const_58,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1022.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1022.getText();
         var _loc3_:String = "model_" + this.var_1021.name;
