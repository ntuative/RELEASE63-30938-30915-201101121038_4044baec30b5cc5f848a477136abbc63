package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_392:IRoomSettingsCtrlOwner;
      ...
      private var var_592:ICheckBoxWindow;
      
      private var var_1733:IWindowContainer;
      ...
      private var var_2434:ITextWindow;
      ...
      {
         this.var_330 = param1;
         this._navigator.send(new GetRoomSettingsMessageComposer(this.var_330));
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1735 = true;
         this.var_392.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_330 || this.var_1112 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1112 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1420)
         {
            this.var_724.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1439)
         {
            this.var_724.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1489)
         {
            this.var_1110.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1499)
         {
            this.setTagError(this.var_871,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_872,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1428)
         {
            ...
            this.setTagError(this.var_872,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1491)
         {
            this.var_903.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_724.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_432,this.onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_694,this.onDoorModePasswordUnselect);
         ...
         Util.setProc(this._window,"edit_thumbnail",this.method_10);
         ...
         this.var_724 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1110 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_871 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_872 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_903 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1111 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1106 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1109 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1113 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_592 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_1733 = IWindowContainer(this._window.findChildByName("header_container"));
         this.var_1363 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1108 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1114 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1732 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         ...
         this.var_2433 = ITextWindow(this._window.findChildByName("basic_caption"));
         this.var_2434 = ITextWindow(this._window.findChildByName("advanced_caption"));
         this.var_1734 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1734.procedure = this.onSwitchView;
         this.var_1107.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1733.visible = this._inRoom;
         this.var_1732.visible = this._inRoom;
         this.var_2434.visible = this.var_477;
         this.var_2433.visible = !this.var_477;
         if(this.var_477)
         {
            this.var_1114.visible = true;
            this.var_1364.visible = false;
            this.refreshFlatControllers();
            this.var_1114.height = Util.getLowestPoint(this.var_1114) + 4;
         }
         else
         {
            this.populateForm();
            this.var_1108.visible = true;
            this.var_1364.visible = true;
            this.var_1363.visible = this._inRoom;
            this._navigator.thumbRenderer.refreshThumbnail(IWindowContainer(this.var_1363.findChildByName("picframe")),this._navigator.data.enteredGuestRoom.thumbnail,false);
            this.var_1108.height = Util.getLowestPoint(this.var_1108) + 4;
         }
         this.var_1734.text = !!this.var_477 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1733.name,this.var_1363.name,this.var_1108.name,this.var_1114.name,this.var_1364.name,this.var_1732.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_724.setText(_loc1_.name);
         this.var_1110.setText(_loc1_.description);
         this.var_903.setText("");
         this.var_1111.setText("");
         ...
         this.setTag(this.var_871,_loc1_.tags[0]);
         this.setTag(this.var_872,_loc1_.tags[1]);
         if(this.var_1106)
         {
            if(_loc1_.allowPets)
            {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_724.getText();
         _loc2_.description = this.var_1110.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_519;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_111)
         {
            _loc8_ = this.var_903.getText();
            _loc9_ = this.var_1111.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_903.clearErrors();
               this.var_1111.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowFoodConsume = this.var_1109.isSelected;
         _loc2_.allowWalkThrough = this.var_1113.isSelected;
         _loc2_.hideWalls = this.var_592.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_871,_loc2_.tags);
         this.addTag(this.var_872,_loc2_.tags);
         this.clearErrors();
      ...
      {
         Logger.log("[RoomSettingsCtrl.onDeleteButtonClick] " + this.var_330);
         this._navigator.registerParameter("navigator.roomsettings.deleteroom.confirm.message","room_name",this.var_75.name);
         var _loc2_:ConfirmDialogView = new ConfirmDialogView(IFrameWindow(this._navigator.getXmlWindow("ros_room_delete_confirm")),this,this.onConfirmRoomDelete,[this.var_330]);
         _loc2_.show();
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_55,HabboWindowStyle.const_30,HabboWindowParam.const_58,new Rectangle(0,0,100,20)));
      }
      ...
      private function onRemoveAllFlatCtrlsClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this._navigator.send(new RemoveAllRightsMessageComposer(this.var_330));
      }
