package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_850:Number = 64;
      
      public static const const_1095:Number = 32;
      ...
      private var var_1749:Number = 1.0;
      
      private var var_76:Vector3d;
      
      private var var_247:Vector3d;
      
      private var var_2723:Number = -500.0;
      
      private var var_2724:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1749 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         return new Vector3d(this.var_168.x,this.var_168.y,this.var_168.z);
      }
      
      public function get location() : IVector3d
      {
         return new Vector3d(this.var_76.x * this.var_396,this.var_76.y * this.var_394,this.var_76.z * this.var_395);
      }
      
      public function get direction() : IVector3d
      {
         return new Vector3d(this.var_247.x,this.var_247.y,this.var_247.z);
      }
      
      public function set x_scale(param1:Number) : void
      {
         if(this.var_396 != param1 * this.var_1748)
         {
            this.var_396 = param1 * this.var_1748;
            ++this.var_146;
         }
      }
      ...
      {
         if(this.var_394 != param1 * this.var_1747)
         {
            this.var_394 = param1 * this.var_1747;
            ++this.var_146;
         }
      }
      ...
      {
         if(this.var_395 != param1 * this.var_1749)
         {
            this.var_395 = param1 * this.var_1749;
            ++this.var_146;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_76.y /= this.var_394;
         this.var_76.z /= this.var_395;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_247.x;
         var _loc3_:Number = this.var_247.y;
         var _loc4_:Number = this.var_247.z;
         this.var_247.assign(param1);
         if(this.var_247.x != _loc2_ || this.var_247.y != _loc3_ || this.var_247.z != _loc4_)
         {
            ++this.var_146;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_167.assign(_loc24_);
            this.var_168.assign(_loc25_);
         }
         else
         {
            this._x.assign(_loc18_);
            this.var_167.assign(_loc19_);
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_479 != null)
         {
            ...
            return this.var_479.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1122.assign(_loc22_);
         }
         else
         {
            this.var_1122.assign(_loc17_);
         }
         ++this.var_146;
      }
      ...
      public function getCoordinatePosition(param1:IVector3d) : IVector3d
      {
         ...
         var _loc3_:Number = Vector3d.scalarProjection(param1,this.var_167);
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= this.var_394;
         _loc2_.z *= this.var_395;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1122);
         if(_loc3_ < this.var_2723 || _loc3_ > this.var_2724)
         {
            return null;
         }
         var _loc4_:Number = Vector3d.scalarProjection(_loc2_,this._x);
         var _loc5_:Number = -Vector3d.scalarProjection(_loc2_,this.var_167);
         _loc4_ *= this._scale;
         _loc5_ *= this._scale;
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_394;
            _loc2_.z *= this.var_395;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1122);
         }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc7_:IVector3d = Vector3d.sum(Vector3d.product(this._x,_loc5_),Vector3d.product(this.var_167,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_76.x * this.var_396,this.var_76.y * this.var_394,this.var_76.z * this.var_395);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = this.var_168;
         var _loc11_:Vector3d = new Vector3d(param2.x * this.var_396,param2.y * this.var_394,param2.z * this.var_395);
         var _loc12_:Vector3d = new Vector3d(param3.x * this.var_396,param3.y * this.var_394,param3.z * this.var_395);
         var _loc13_:Vector3d = new Vector3d(param4.x * this.var_396,param4.y * this.var_394,param4.z * this.var_395);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1095;
         }
         else
         {
            this.scale = const_850;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_850;
      }
