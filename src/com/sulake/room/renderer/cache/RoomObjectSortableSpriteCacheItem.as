package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectSortableSpriteCacheItem
   {
      ...
      public function method_1(param1:int) : SortableSprite
      {
      ...
      {
         if(param1 != this.var_2146 || param2 != this.var_2147)
         {
      ...
      public function setSpriteCount(param1:int) : void
      {
         ...
         if(param1 < this.var_188.length)
         {
            ...
            this.var_188.splice(param1,this.var_188.length - param1);
         }
