package com.sulake.room.renderer.utils
{
   ...
   public class ExtendedSprite extends Bitmap
   {
      ...
      {
         if(param1 != this.var_1495 || param2 != this.var_1496)
         {
      ...
      {
         if(this.var_1232 > 255 || bitmapData == null)
         {
            return false;
         }
