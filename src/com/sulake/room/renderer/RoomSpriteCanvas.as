package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_1613:int = 50;
      ...
      private var var_465:Point;
      
      private var var_243:BitmapDataCache;
      
      private var var_576:RoomObjectCache;
      
      private var var_466:Array;
      
      private var var_574:Array;
      
      private var var_1338:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2335:Number = -1.0E7;
      
      private var var_2337:Number = -1.0E7;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this.var_244.addChild(this.var_54);
         ...
         this.var_576 = new RoomObjectCache(_loc6_);
      ...
      {
         this.var_465.x -= param1 - this.var_575;
         this.var_575 = param1;
      }
      
      public function set screenOffsetY(param1:int) : void
      {
         this.var_465.y -= param1 - this.var_577;
         this.var_577 = param1;
      }
      ...
      {
         if(param1 && !this.var_907)
         {
            this.var_907 = true;
            if(this.var_119 != null && !this.var_244.contains(this.var_119))
            {
               this.var_244.addChild(this.var_119);
               this.var_54.mask = this.var_119;
            }
         }
         else if(!param1 && this.var_907)
         {
            this.var_907 = false;
            if(this.var_119 != null && this.var_244.contains(this.var_119))
            {
               this.var_244.removeChild(this.var_119);
      ...
      {
         this.var_576.removeObjectCache(param1);
      }
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_713 != this.var_2333 || this._ht != this.var_2334)
         {
            _loc9_ = true;
         }
         if(this.var_54.x != this.var_575 || this.var_54.y != this.var_577)
         {
            this.var_54.x = this.var_575;
            this.var_54.y = this.var_577;
            _loc9_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_466.sortOn("z",0 | 0);
         if(_loc5_ < this.var_466.length)
         {
            this.var_466.splice(_loc5_);
         }
         var _loc10_:* = null;
         _loc4_ = 0;
         while(_loc4_ < _loc5_)
         {
            _loc10_ = this.var_466[_loc4_] as SortableSprite;
            if(_loc10_ != null)
            {
         ...
         this.var_2333 = this.var_713;
         this.var_2334 = this._ht;
      }
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         if(_loc6_ == null)
         {
            this.var_576.removeObjectCache(param2);
            return 0;
         }
         var _loc7_:RoomObjectCacheItem = this.var_576.getObjectCache(param2);
         ...
         {
            _loc18_ = _loc6_.method_1(_loc21_);
            if(_loc18_ != null && _loc18_.visible)
            {
               _loc22_ = _loc18_.asset;
               if(_loc22_ != null)
               {
                  _loc19_ = _loc13_ + _loc18_.offsetX + this.var_575;
                  _loc20_ = _loc14_ + _loc18_.offsetY + this.var_577;
                  if(_loc19_ < this.var_713 && _loc19_ + _loc22_.width >= 0 && (_loc20_ < this._ht && _loc20_ + _loc22_.height >= 0))
                  {
                     _loc17_ = _loc9_.method_1(_loc16_);
                     if(_loc17_ == null)
                     {
                        _loc17_ = new SortableSprite();
                        _loc9_.addSprite(_loc17_);
                        this.var_466.push(_loc17_);
                        _loc17_.name = param2;
                     }
                     _loc17_.sprite = _loc18_;
                     _loc17_.x = _loc19_ - this.var_575;
      ...
      private function method_1(param1:int) : ExtendedSprite
      {
      ...
      {
         if(param1 < 0 || param1 >= this.var_466.length)
         {
            return null;
         }
         return this.var_466[param1] as SortableSprite;
      }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         param1 -= this.var_575;
         param2 -= this.var_577;
         this.var_465.x = param1;
         this.var_465.y = param2;
         if(this.var_1083 > 0 && param3 == MouseEvent.MOUSE_MOVE)
         {
            return this.var_1679;
         }
         this.var_1679 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1083;
         return this.var_1679;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_713 / 2;
      ...
      private function checkMouseHits(param1:int, param2:int, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = this.var_578.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        this.var_578.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2335 || param2 != this.var_2337)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = this.var_578.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = this.var_578.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = this.createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  this.bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function bufferMouseEvent(param1:RoomSpriteMouseEvent, param2:String) : void
      {
         ...
         {
            this.var_327.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_327 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_327.getKey(_loc1_);
            _loc3_ = this.var_327.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1338.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
      ...
      public function update() : void
      {
         if(this.var_1083 == 0)
         {
            this.checkMouseHits(this.var_465.x,this.var_465.y,MouseEvent.MOUSE_MOVE);
         }
         this.var_1083 = 0;
         ++this.var_1680;
      }
