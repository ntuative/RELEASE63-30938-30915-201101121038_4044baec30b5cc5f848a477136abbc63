package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_325:IRoomObjectController;
      ...
      {
         if(this.var_325 == param1)
         {
            return;
         }
         if(this.var_325 != null)
         {
            this.var_325.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_325 = param1;
            this.var_325.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_325 != null)
            {
               this.var_325.setLocation(param1.loc);
               this.var_325.setDirection(param1.dir);
            }
         }
      }
   }
