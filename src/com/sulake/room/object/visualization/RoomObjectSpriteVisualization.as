package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_325:IRoomObject;
      
      private var var_1348:IGraphicAssetCollection;
      
      protected var var_425:int = -1;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_188 != null)
         {
            ...
            {
               _loc1_ = this.var_188[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(this.var_188.length > param1)
         {
            _loc2_ = this.var_188[this.var_188.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      public function method_1(param1:int) : IRoomObjectSprite
      {
         if(param1 >= 0 && param1 < this.var_188.length)
         {
      ...
      {
         this.var_425 = 4294967295;
         this.var_222 = 4294967295;
         this.var_221 = -1;
      }
