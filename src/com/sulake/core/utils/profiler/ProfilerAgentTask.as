package com.sulake.core.utils.profiler
{
   ...
   public class ProfilerAgentTask implements IDisposable
   {
      ...
      public function stop() : void
      {
         if(this.var_674)
         {
            this.var_1766 = getTimer() - this.var_2469;
            ++this.var_1131;
            this.var_1381 += this.var_1766;
            this.var_1765 = this.var_1381 / this.var_1131;
            this.var_674 = false;
         }
      }
