package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1097:Map = new Map();
      
      private static var var_720:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         var _loc1_:String = "";
         var _loc2_:int = 0;
         while(_loc2_ < var_720.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_720.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_720.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_720.remove(param1);
         var_720.add(param1,param2);
      }
      ...
      {
         return var_1097[param1];
      }
      
      public static function getParameterNames() : Array
      {
         return var_1097.getKeys();
      }
   }
}
