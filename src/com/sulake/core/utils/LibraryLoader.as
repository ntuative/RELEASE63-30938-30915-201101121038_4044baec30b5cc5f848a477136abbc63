package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1579:uint = 1;
      
      protected static const const_1578:uint = 2;
      
      protected static const const_1581:uint = 4;
      
      protected static const const_1580:uint = 3;
      ...
      public static const const_1358:int = 2;
      
      private static var var_806:Array = new Array();
      
      private static var var_652:Array = new Array();
      ...
      protected var var_219:URLRequest;
      
      protected var var_703:XML;
      
      protected var var_560:Class;
      ...
      protected var var_958:Boolean = false;
      ...
      protected var var_1193:int;
      
      protected var var_1192:int;
      
      protected var var_2771:uint = 0;
      
      protected var var_2682:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_38.load(param1.var_219,param1.var_15);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_956)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_652[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_652.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_652.length < const_1358 && false)
            {
               _loc1_ = var_806.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_652.push(_loc1_);
                  _loc1_.var_38.load(_loc1_.var_219,_loc1_.var_15);
               }
            }
         }
      }
      ...
      {
         return !!this.var_219 ? this.var_219.url : null;
      }
      ...
      {
         return !!this.var_957 ? uint(this.var_1193 - this.var_1932) : uint(getTimer() - this.var_1932);
      }
      ...
      public function load(param1:URLRequest, param2:int = 5) : void
      {
         ...
         this._name = parseNameFromUrl(this.var_219.url);
      ...
      {
         if(this.var_958 && !_disposed)
         {
            this.var_958 = false;
            if(!this.var_957 && this.var_219)
            {
               this.var_1193 = -1;
      ...
      {
         if(!this.var_957 && !_disposed && this.var_1192 > 0)
         {
            try
            {
               this.var_38.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_219,const_1541 - this.var_1192);
            if(this.var_2682)
            {
               this.var_219.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_219.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_2682 = false;
            }
            --this.var_1192;
            this.var_417 = 0;
            this.var_38.load(this.var_219,this.var_15);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case TimerEvent.TIMER:
               ...
               if(!_disposed)
               {
                  this.var_417 = LibraryLoader.name_2;
         ...
         if(this.var_417 == LibraryLoader.const_1580)
         {
         ...
         if(this.var_417 == LibraryLoader.name_2)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_560 = this.getDefinition(this._name) as Class;
         if(this.var_560 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_219.url + "!");
            }
            return false;
         }
         try
         {
            xmlClass = this.var_560.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
         ...
         try
         {
            this.var_703 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())
