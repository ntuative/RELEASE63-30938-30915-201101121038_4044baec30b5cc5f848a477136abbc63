package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_493:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_574:String = "{";
      
      private static const const_575:String = "}";
      
      private static const const_1246:String = "/*";
      
      private static const const_1245:String = "*/";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_82[const_181],var_82[ITALIC],var_82[BOLD]];
            var_82.reset();
            var_82[const_181] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_493.indexOf(_loc4_.name) == -1)
            {
               var_493.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_575);
         if(countSubStrings(param1,const_574) != countSubStrings(param1,const_575))
         {
            throw new Error("Mismatching amount of \"" + const_574 + "\" versus \"" + const_575 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1246) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1245) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_574)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
