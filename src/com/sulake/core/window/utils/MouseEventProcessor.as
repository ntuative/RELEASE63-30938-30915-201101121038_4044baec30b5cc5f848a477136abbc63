package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_779:IWindowContextStateListener;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         var _loc6_:* = null;
         var _loc8_:* = null;
         this.var_133 = param1.desktop;
         this.var_77 = param1.var_1190 as WindowController;
         this._lastClickTarget = param1.var_1188 as WindowController;
         this.var_152 = param1.renderer;
         this.var_779 = param1.var_1189;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_631.x || _loc3_.stageY != this.var_631.y)
            {
               this.var_631.x = _loc3_.stageX;
               this.var_631.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_133.groupParameterFilteredChildrenUnderPoint(this.var_631,_loc6_,WindowParam.const_28);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_77 != this.var_133 && !this.var_77.disposed)
                  {
                     ...
                     this.var_77 = WindowController(this.var_133);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_77 && !this.var_77.disposed)
                     {
                        ...
                        {
                           this.var_779.mouseEventReceived(_loc3_.type,this.var_77);
                        }
                     }
                  }
         ...
         param2.end();
         param1.desktop = this.var_133;
         param1.var_1190 = this.var_77;
         param1.var_1188 = this._lastClickTarget;
         param1.renderer = this.var_152;
         param1.var_1189 = this.var_779;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_481))
         {
