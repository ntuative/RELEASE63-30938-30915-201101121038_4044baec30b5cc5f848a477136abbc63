package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_991:String = "_EXCLUDE";
      
      public static const const_1737:String = "_INCLUDE";
      
      public static const const_1764:String = "_TEMP";
      
      private static const const_1270:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1271:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_966:Dictionary;
      
      protected var var_1459:Dictionary;
      
      protected var var_1954:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1208);
         this.var_966 = new Dictionary();
         this.var_1459 = new Dictionary();
         ParamCodeTable.fillTables(this.var_966,this.var_1459);
         this.var_1954 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1271,"");
         return param1.replace(const_1270,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1208)
            {
               delete this.var_1208[_loc1_];
            }
            for(_loc1_ in this.var_966)
            {
               delete this.var_966[_loc1_];
            }
            for(_loc1_ in this.var_1459)
            {
               delete this.var_1459[_loc1_];
            }
            this.var_1954.dispose();
            this.var_1954 = null;
            this.var_15 = null;
            this._disposed = true;
         }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1208[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_991) == -1)
                  {
