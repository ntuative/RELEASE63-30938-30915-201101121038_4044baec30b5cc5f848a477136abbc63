package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_384:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_67))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_384)
         {
            this.var_384.removeEventListener(WindowEvent.const_277,this.scrollBarEventProc);
            this.var_384.removeEventListener(WindowEvent.const_231,this.scrollBarEventProc);
            this.var_384 = null;
         }
         if(this.var_1081)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1081)
         {
            this.var_1081 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_384)
         {
            this.var_384 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_384)
            {
               this.var_384.addEventListener(WindowEvent.const_277,this.scrollBarEventProc);
               this.var_384.addEventListener(WindowEvent.const_231,this.scrollBarEventProc);
            }
         }
         return this.var_384;
      }
