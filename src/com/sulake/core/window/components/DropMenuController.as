package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      private var var_165:DropMenuController;
      ...
      {
         if(param1 > this.var_237.lenght - 1)
         {
         ...
         if(!_loc2_.isWindowOperationPrevented())
         {
            this.var_555 = param1;
            this.closeMenuView();
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_334,this,null));
         }
      }
      ...
      {
         if(this.var_165 != null && !this.var_165.disposed)
         {
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_165 == null || this.var_165.disposed)
         {
            this.var_165 = context.create(name + "::submenu","",WindowType.const_513,var_78,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_165.setGlobalRectangle(_loc1_);
         }
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_237.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_860 = true;
         this.closeMenuView();
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_165.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function openMenuView() : void
      {
         if(!this.var_860)
         {
            if(this.open())
            {
               if(this.var_237.length)
               {
                  this.populateMenuItemContainer(this.var_237,this.getSubMenu(),this.subMenuEventProc);
                  this.var_860 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_860 = false;
            this.getTitleLabel().text = this.var_555 < this.var_237.length && this.var_555 > -1 ? this.var_237[this.var_555] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_548,var_78,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_369,var_78,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_555 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_555).setStateFlag(WindowState.WINDOW_STATE_SELECTED,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_551)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_939:
            case WindowMouseEvent.const_57:
               ...
               break;
            case WindowTouchEvent.const_647:
            case WindowMouseEvent.const_42:
               ...
               break;
            case WindowEvent.const_674:
               if(param2 == this.var_165)
               {
                  this.closeMenuView();
               }
         }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_237[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_237.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_837,this.var_237,PropertyStruct.const_136,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1333);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_837)
            {
