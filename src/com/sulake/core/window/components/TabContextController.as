package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1216:String = "_SELECTOR";
      
      private static const const_1217:String = "_CONTENT";
       
      
      protected var var_961:ITabSelectorWindow;
      
      protected var var_1945:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_961 = findChildByTag(const_1216) as ITabSelectorWindow;
            if(this.var_961 != null)
            {
               this.var_961.procedure = this.selectorEventProc;
            }
         }
         return this.var_961;
      }
      ...
      {
         if(this.var_1945 == null)
         {
            this.var_1945 = findChildByTag(const_1217) as IWindowContainer;
         }
      ...
      {
         return !!this.var_700 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_961.numSelectables;
      }
