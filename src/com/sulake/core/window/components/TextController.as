package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1159:Dictionary = createPropertySetterTable();
      
      protected static const ZERO_RECT:Rectangle = new Rectangle();
      
      protected static const const_1577:Array = [AntiAliasType.ADVANCED,AntiAliasType.NORMAL];
      
      protected static const const_1576:Array = [GridFitType.PIXEL,GridFitType.NONE,GridFitType.SUBPIXEL];
      
      protected static const const_1575:Array = [TextFieldAutoSize.NONE,TextFieldAutoSize.LEFT,TextFieldAutoSize.RIGHT,TextFieldAutoSize.CENTER];
       
      
      protected var _field:TextField;
      
      protected var var_775:Number;
      
      protected var var_516:Number;
      ...
      protected var var_956:Boolean = false;
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_361,this.var_192);
      ...
      {
         return TextStyleManager.getStyleNameArrayRef();
      }
      ...
      private static function setHtmlText(param1:TextController, param2:String) : void
      {
         ...
         if(param1.var_114)
         {
            param1.context.removeLocalizationListener(param1.var_24,param1);
            param1.var_114 = false;
         }
         param1.var_24 = param2;
         if(param1.var_24.charAt(0) == "$" && param1.var_24.charAt(1) == "{")
         {
            param1.context.registerLocalizationListener(param1.var_24.slice(2,param1.var_24.indexOf("}")),param1);
            param1.var_114 = true;
         }
         else if(param1._field != null)
         {
            param1._field.htmlText = param1.var_24;
            param1.refreshTextImage();
         }
      }
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_361 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_361,param1.var_192);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_823 ? true : null;
         }
      ...
      {
         this.var_775 = param1;
         this._field.scrollH = this.var_775 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_775 * this.maxScrollH,this.var_516 * this.maxScrollV,width,height);
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_775 = this.var_775;
         _loc1_.var_516 = this.var_516;
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:Object = TextStyleManager.getStyle(this.var_361);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_247,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(new PropertyStruct("text_color",this._field.textColor,PropertyStruct.const_127,this._field.textColor != _loc2_.color));
         _loc1_.push(new PropertyStruct("antialias_type",this._field.antiAliasType,PropertyStruct.const_52,this._field.antiAliasType != AntiAliasType.ADVANCED,const_1577));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",this._field.gridFitType,PropertyStruct.const_52,this._field.gridFitType != GridFitType.PIXEL,const_1576));
         ...
         _loc1_.push(new PropertyStruct("auto_size",this.var_416,PropertyStruct.const_52,this.var_416 != TextFieldAutoSize.NONE,const_1575));
         ...
         if(this._field.mouseWheelEnabled != PropertyDefaults.const_1010)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_768,this._field.mouseWheelEnabled,PropertyStruct.const_38,true));
         }
         else
         {
