package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1233:String = "_TITLE";
      
      private static const const_1277:String = "_HEADER";
      
      private static const const_1275:String = "_CONTENT";
      
      private static const const_1276:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1439:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1233) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1439 = findChildByTag(const_1277) as IHeaderWindow;
            if(!this.var_1439)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_162 = findChildByTag(const_1275) as IWindowContainer;
            if(!this.var_162)
            {
      ...
      {
         return findChildByTag(const_1276) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1160,_loc2_,false);
      ...
      {
         return this.content != null && this.var_957 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc3_:Boolean = testParamFlag(WindowParam.const_199);
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_303,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_297,_loc3_.left,PropertyStruct.const_36,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_272,_loc3_.top,PropertyStruct.const_36,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_300,0 - _loc3_.right,PropertyStruct.const_36,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_271,0 - _loc3_.bottom,PropertyStruct.const_36,_loc2_));
         }
         else
         {
