package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      protected static const const_1160:String = "_COLORIZE";
      
      protected static const const_1582:String = "_IGNORE_INHERITED_STYLE";
      
      private static var var_1265:Point = new Point();
      ...
      protected var var_633:Function;
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(_loc13_)
         {
            var_764 = _loc13_.blend;
            var_421 = _loc13_.treshold;
            if(var_422 != _loc13_.background)
            {
      ...
      {
         return this.var_633 != null ? this.var_633 : (this._parent != null ? this._parent.procedure : this.nullEventProc);
      }
      ...
      {
         var_422 = param1;
         var_220 = !!var_422 ? uint(var_220 | var_520) : uint(var_220 & 16777215);
      ...
      {
         var_520 = param1 & 4278190080;
         var_220 = !!var_422 ? uint(param1) : uint(param1 & 16777215);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_63);
      }
      ...
      {
         var_520 = param1 << 24;
         var_220 = !!var_422 ? uint(var_520 | var_220) : uint(16777215 & var_220);
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_63);
      }
      
      public function set blend(param1:Number) : void
      {
         var_764 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
         var_15.invalidate(this,var_11,WindowRedrawFlag.const_1132);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_509,this,null));
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         {
            var_78 = param1;
            this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_431,this,null));
         }
      }
      ...
      {
         var_421 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_311 = this._parent.rectangle.clone();
               var_57.x = var_11.x;
               var_57.y = var_11.y;
               var_57.width = var_11.width;
               var_57.height = var_11.height;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_402,this,this._parent));
            }
            else
            {
               this.var_311.x = 0;
               this.var_311.y = 0;
               this.var_311.width = 0;
               this.var_311.height = 0;
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_936,this,_loc2_));
            }
         }
      }
      ...
      public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         ...
         {
            this.var_20 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_746,var_11);
            this.var_20.visible = var_358;
         }
         return this.var_20;
      }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_78,var_19,var_15,var_11,null,this.var_633,this.properties,var_781.concat(),_id) as WindowController;
         _loc2_.var_421 = var_421;
         _loc2_.var_153 = this.var_153;
         _loc2_._debug = this._debug;
         _loc2_.var_311 = this.var_311.clone();
         ...
         _loc2_.var_520 = var_520;
         _loc2_.var_780 = var_780;
         _loc2_.var_358 = var_358;
         _loc2_.var_764 = var_764;
         _loc2_.var_19 = var_19;
         _loc2_._state = _state;
         _loc2_._name = _name;
         _loc2_._id = _id;
         _loc2_.caption = var_24;
         _loc2_.background = var_422;
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(true)
            {
               ...
               {
                  if(this.getStateFlag(WindowState.const_95))
                  {
                     this.deactivate();
                  }
               }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2118 + "]";
      }
      ...
      override public function invalidate(param1:Rectangle = null) : void
      {
         ...
         var_15.invalidate(this,param1,WindowRedrawFlag.const_63);
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_520)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_949,this,null,true);
            ...
            if(_loc6_)
            {
               _loc9_ = new WindowNotifyEvent(WindowNotifyEvent.const_690,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_514,this,null));
            }
            if(_loc6_)
            {
      ...
      public function getRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null, param4:Rectangle = null) : void
      {
         ...
         if(param3 != null && var_131 != null)
         {
            param3.x = var_131.x;
            param3.y = var_131.y;
            param3.width = var_131.width;
            param3.height = var_131.height;
         }
         if(param4 != null && var_132 != null)
         {
            param4.x = var_132.x;
            param4.y = var_132.y;
            param4.width = var_132.width;
            param4.height = var_132.height;
         }
      }
      ...
      public function setRegionProperties(param1:Rectangle = null, param2:Rectangle = null, param3:Rectangle = null) : void
      {
         if(param3 != null)
         {
            ...
            var_132.x = param3.x;
            var_132.y = param3.y;
            var_132.width = param3.width;
            var_132.height = param3.height;
         }
         if(param2 != null)
         {
            ...
            var_131.x = param2.x;
            var_131.y = param2.y;
            var_131.width = param2.width;
            var_131.height = param2.height;
         }
      ...
      {
         return !testParamFlag(WindowParam.const_31) ? this.getGraphicContext(true).fetchDrawBuffer() : (this._parent != null ? this._parent.fetchDrawBuffer() : null);
      }
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_42:
                  ...
                  if(testParamFlag(WindowParam.const_348))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_215))
                        {
               ...
               case WindowMouseEvent.const_57:
                  ...
                  if(testParamFlag(WindowParam.const_215))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_173:
                  var_15.invalidate(this,var_11.union(var_57),WindowRedrawFlag.RESIZE);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_419,this,null));
                     if(testParamFlag(WindowParam.const_171,WindowParam.const_151))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_184,WindowParam.const_143))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        ...
                        var_19 = _loc9_;
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_305,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_514:
                  var_15.invalidate(this,var_11.union(var_57),WindowRedrawFlag.const_433);
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_926,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_266,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_337:
                  if(param1 == this)
                  {
                     this.notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_852,this,null));
                     if(this._parent != null)
                     {
                        this._parent.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_235,this._parent,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_509:
                  var_15.invalidate(this,var_11,WindowRedrawFlag.const_1135);
                  break;
               case WindowNotifyEvent.const_431:
                  ...
                  while(--_loc7_ > -1)
                  {
                     ...
                     if(_loc8_.tags.indexOf(const_1582) == -1)
                     {
                        _loc8_.style = var_78;
                     }
                  }
               ...
               case WindowNotifyEvent.const_434:
                  if(!(var_19 & 0))
                  {
                     if(!this.var_20)
                     {
                        ...
                        var_15.invalidate(this,var_11,WindowRedrawFlag.const_433);
                     }
                  }
                  else if(var_19 & 0)
                  {
               ...
               case WindowNotifyEvent.const_419:
                  this._parent.getRegionProperties(null,this.var_311);
                  this.updateScaleRelativeToParent();
                  break;
      ...
      protected function forwardNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowNotifyEvent.const_1053:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_1446:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1083:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1142:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_1143:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1138:
               _loc2_ = "null";
               break;
         ...
         if(_loc2_ == WindowEvent.const_145)
         {
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_421);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_421);
      }
         ...
         if(this.var_153 && var_421 > 0)
         {
            if(!testParamFlag(WindowParam.const_31))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1265,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1265,param3,param1)) : false;
            }
         }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc8_:Boolean = this.getParamFlag(WindowParam.const_60);
         ...
         if(_loc7_)
         {
            if(_loc8_)
            {
               this.setParamFlag(WindowParam.const_60,false);
            }
            ...
            if(_loc8_)
            {
               this.setParamFlag(WindowParam.const_60,true);
            }
         }
      }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_116,WindowParam.const_151);
         var _loc2_:* = !testParamFlag(WindowParam.const_134,WindowParam.const_143);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_311.width;
               ...
               {
                  if(this._parent.width < _loc3_.width && this.getParamFlag(WindowParam.const_31))
                  {
                     _loc3_.x = 0;
                  }
                  else
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_311.height;
               _loc5_ = uint(var_19 & 0);
               if(_loc5_ == WindowParam.const_388)
               {
               ...
               {
                  if(this._parent.height < _loc3_.height && this.getParamFlag(WindowParam.const_31))
                  {
                     _loc3_.y = 0;
                  }
                  else
      ...
      {
         if(_state == WindowState.const_406)
         {
            return true;
         }
         _state = WindowState.const_406;
      ...
      public function minimize() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1142;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function lock() : Boolean
      {
         ...
         this.setStateFlag(WindowState.const_62,true);
         _loc1_.type = WindowNotifyEvent.const_1158;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_1036,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
      ...
      public function focus() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_1138;
         this.update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1014 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_357,this,param1));
         return param1;
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1014 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         this.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_626,this,param1));
         return param1;
      }
