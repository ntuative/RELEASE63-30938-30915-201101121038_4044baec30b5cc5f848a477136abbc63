package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1547:uint = 0;
      
      public static const const_746:uint = 1;
      
      public static const const_1085:uint = 2;
      
      public static const const_718:uint = 4;
      
      public static const const_1498:uint = 8;
      
      public static const const_1324:uint = 16;
      
      public static const const_1864:uint = 64;
      
      public static const const_1728:uint = 128;
      
      public static const const_1065:uint = 256;
      
      protected static var var_523:uint = 0;
      
      protected static var var_298:uint = 0;
       
      
      protected var var_191:DisplayObjectContainer;
      
      protected var var_1940:Boolean;
      
      protected var var_778:Boolean;
      ...
      public function GraphicContext(param1:String, param2:uint, param3:Rectangle)
      {
         ...
         switch(param2)
         {
            ...
            case GraphicContext.const_1085:
               ...
               break;
            case GraphicContext.const_1498:
               this.setDisplayObject(new Shape());
               break;
            case GraphicContext.const_1324:
               this.setDisplayObject(new MorphShape());
               break;
            case GraphicContext.const_718:
               this.setDisplayObject(new Sprite());
               break;
            case GraphicContext.const_1065:
               break;
            case GraphicContext.const_1547:
               break;
            default:
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_191.numChildren > 0)
               {
                  this.var_191.removeChildAt(0);
               }
            }
            this.var_191 = null;
            while(numChildren > 0)
         ...
         if(this.var_778)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_298 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1940,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1940,16777215);
                  }
                  var_298 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_778)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_298 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_191 == null)
         {
            this.var_191 = new Sprite();
            this.var_191.name = this.name + " - Child Container";
            this.var_191.mouseEnabled = false;
            addChild(this.var_191);
         }
         return this.var_191;
      }
      ...
      {
         return this.var_191 != null ? int(this.var_191.numChildren) : 0;
      }
