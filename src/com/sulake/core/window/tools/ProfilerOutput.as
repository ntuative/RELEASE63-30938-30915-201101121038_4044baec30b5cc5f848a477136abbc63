package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1390:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1391:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_147:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_147 = this.profiler;
         this._windowManager = param2;
         this.var_917 = param3;
         var _loc4_:ByteArray = new var_1390() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_147)
         {
            this.var_147.removeStopEventListener(this.refresh);
            this.var_147 = null;
         }
         if(!this.var_147 && param1)
         {
            this.var_147 = param1;
            this.var_147.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_841)
            {
               this.var_1780 = false;
               ITextWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_147.getProfilerAgentsInArray();
         ...
         if(this.var_1780)
         {
            ITextWindow(this._window.findChildByName("footer")).text = "Assets - Libraries: " + this.var_147.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_147.numBitmapAssetInstances + " / " + this.var_147.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this.var_917.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_147.numTrackedBitmapDataInstances + " / " + this.var_147.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1391() as ByteArray;
