package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_359:Rectangle;
      ...
      protected var var_422:Boolean = false;
      
      protected var var_220:uint = 16777215;
      
      protected var var_520:uint;
      
      protected var var_421:uint = 10;
      
      protected var var_780:Boolean = true;
      
      protected var var_358:Boolean = true;
      ...
      protected var var_24:String = "";
      
      protected var _name:String;
      
      protected var _id:uint;
      
      protected var var_781:Array;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this._type = param3;
         this.var_19 = param5;
         this._state = WindowState.const_92;
         this.var_78 = param4;
         this.var_781 = param8 == null ? new Array() : param8;
         this.var_15 = param6;
         this.var_11 = param7.clone();
         this.var_359 = param7.clone();
      ...
      {
         return this.var_359.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_359.height;
      }
