package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_964 = new LoaderContext();
         this.var_964.checkPolicyFile = true;
         ...
         {
            this.var_38.load(param2,this.var_964);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_297 = 0;
         this.var_38.load(param1,this.var_964);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_297 < var_2690)
            {
               ...
               this.var_38.load(new URLRequest(this.var_962 + (this.var_962.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_297),this.var_964);
               return true;
            }
         }
         return false;
