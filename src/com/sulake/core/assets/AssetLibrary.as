package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_959:String = "AssetLibraryReady";
      
      public static const const_605:String = "AssetLibraryLoaded";
      
      public static const const_1418:String = "AssetLibraryUnloaded";
      
      public static const const_1551:String = "AssetLibraryLoadError";
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_866.splice(var_866.indexOf(this),1);
            --var_461;
            this.var_460 = null;
            this.var_868 = null;
            this.var_141 = null;
      ...
      {
         if(this._file == param1.url && this.var_867)
         {
            if(!this.var_865 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this.var_703,this.var_560);
            }
            this.var_865 = param2;
      ...
      {
         var _loc2_:Class = this.var_868[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1081,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1116,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_982,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_969,this.assetLoadEventHandler);
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_381;
                     this.var_380.push(struct.assetName);
                  }
      ...
      {
         return param1 < this.var_380.length ? this.getAssetByName(this.var_380[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_141)
         {
            ...
            {
               return this.var_380.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      {
         return this.var_141[param1] != null || (this.var_560 != null ? this.var_560[param1] != null : false);
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_703 = _loc2_.manifest.copy();
         this.var_560 = _loc2_.resource;
         ...
         this.var_867 = true;
         dispatchEvent(new Event(AssetLibrary.const_605));
         dispatchEvent(new Event(AssetLibrary.const_959));
         if(this.var_865)
         {
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this.var_703.child("library");
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            ...
            while(_loc7_ < _loc6_)
            {
               ...
               if(_loc3_.attribute("name").toString() == param1)
               {
                  ...
                  _loc5_.setUnknownContent(this.var_560[param1]);
