package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1257:String = "asset-libraries";
      
      private static const const_1261:String = "library";
      
      private static const const_1256:String = "service-libraries";
      
      private static const const_1258:String = "library";
      
      private static const const_1260:String = "component-libraries";
      
      private static const const_1262:String = "library";
      
      private static const const_1259:String = "error_data";
      
      private static const const_1254:String = "error_cat";
      
      private static const const_1255:String = "error_desc";
       
      
      private var var_346:LibraryLoaderQueue;
      
      private var var_750:IEventDispatcher;
      
      private var var_501:uint;
      
      private var var_502:Function;
      
      private var var_256:Profiler;
      
      private var var_500:Array;
      
      private var var_616:Array;
      
      private var var_1842:uint;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         var_419 = param1;
         var _loc3_:int = 0;
         while(_loc3_ < CoreComponentContext.const_142)
         {
            this.var_500.push(new Array());
            this.var_616.push(0);
            _loc3_++;
         }
         this.var_1842 = getTimer();
         attachComponent(this,[new IIDCore()]);
         var_419.addEventListener(Event.ENTER_FRAME,this.onEnterFrame);
         switch(param2 & 0)
         {
            case Core.const_1093:
               debug("Core; using simple frame update handler");
               this.var_502 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_821:
               debug("Core; using complex frame update handler");
               this.var_502 = this.complexFrameUpdateHandler;
               break;
            case Core.const_1423:
               debug("Core; using profiler frame update handler");
               this.var_502 = this.profilerFrameUpdateHandler;
               this.var_256 = new Profiler(this);
               attachComponent(this.var_256,[new IIDProfiler()]);
               var_419.addChild(new ProfilerViewer(this.var_256));
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_502 = this.debugFrameUpdateHandler;
         }
      }
      
      public function getNumberOfFilesPending() : uint
      {
         return this.var_346.length;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            var_419.removeEventListener(Event.ENTER_FRAME,this.onEnterFrame);
            var_419 = null;
            _loc3_ = 0;
            while(_loc3_ < CoreComponentContext.const_142)
            {
               _loc2_ = this.var_500[_loc3_] as Array;
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1259,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1254,String(param3));
         ErrorReportStorage.setParameter(const_1255,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         if(this.var_346 == null)
         {
            this.var_346 = new LibraryLoaderQueue(_debug);
         }
         try
         {
            node = config.child(const_1257)[0];
            if(node != null)
            {
         ...
         {
            error("Failed to parse asset libraries from config xml!",true,Core.const_267,e);
         }
         try
         {
         ...
         {
            error("Failed to parse interfaces from config xml!",true,Core.const_267,e);
         }
         try
         {
         ...
         {
            error("Failed to parse components from config xml!",true,Core.const_267,e);
         }
         if(!disposed)
         {
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1436);
         if(!disposed)
         {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_750)
                  {
                     this.var_750.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_501 - this.var_346.length,this.var_501,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         param2 = param2 >= CoreComponentContext.const_142 ? 4294967295 : uint(param2);
         var _loc3_:Array = this.var_500[param2] as Array;
         _loc3_.push(param1);
      }
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         while(_loc4_ < CoreComponentContext.const_142)
         {
            _loc3_ = this.var_500[_loc4_] as Array;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_502(_loc2_,_loc2_ - this.var_1842);
         this.var_1842 = _loc2_;
      }
      ...
      private function simpleFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         criticality = 0;
         while(criticality < CoreComponentContext.const_142)
         {
            this.var_616[criticality] = 0;
            receivers = this.var_500[criticality];
            index = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         var msCurrentTime:uint = param1;
         var msSinceLastUpdate:uint = param2;
         var maxTimePerFrame:uint = 1000 / var_419.stage.frameRate;
         criticality = 0;
         while(criticality < CoreComponentContext.const_142)
         {
            t = getTimer();
            ...
            {
               if(this.var_616[criticality] < criticality)
               {
                  ++this.var_616[criticality];
                  skip = true;
               }
            }
            if(!skip)
         ...
         while(criticality < CoreComponentContext.const_142)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_256.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
      ...
      private function debugFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(_loc3_ < CoreComponentContext.const_142)
         {
            this.var_616[_loc3_] = 0;
            _loc4_ = this.var_500[_loc3_];
            _loc7_ = 0;
